<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_ExecutiveMarketInquiry_Map_Doctor.aspx.cs" Inherits="InfoQuestForm.Form_ExecutiveMarketInquiry_Map_Doctor" MaintainScrollPositionOnPostback="true" %>
...
<head runat="server">
  <title>InfoQuest - Executive Market Inquiry - Map - Doctor</title>
  ...
  <asp:PlaceHolder runat="server">
    ...
    <script src="App_Javascripts/Form_ExecutiveMarketInquiry_Map_Doctor.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>"></script>
...
<body>
  <form id="form_ExecutiveMarketInquiry_Map_Doctor" runat="server">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <Navigation:NavigationMenu ID="NavigationMenu_Page" runat="server" />
    <div>
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_ExecutiveMarketInquiry_Map_Doctor" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_ExecutiveMarketInquiry_Map_Doctor" AssociatedUpdatePanelID="UpdatePanel_ExecutiveMarketInquiry_Map_Doctor">
        <ProgressTemplate>
      ...
      <asp:UpdatePanel ID="UpdatePanel_ExecutiveMarketInquiry_Map_Doctor" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td>
            ...
            <tr>
              <td>
                <table class="Table_Body">
                  ...
                  <tr id="Doctor1">
                    <td class="Table_BodyHeaderBlue">Doctor
                    </td>
                  </tr>
                  <tr id="Doctor2">
                    <td>Sub Region:&nbsp;
                      <asp:DropDownList ID="DropDownList_Doctor_SubRegion" runat="server" DataSourceID="ObjectDataSource_Doctor_SubRegion" AppendDataBoundItems="True" DataTextField="SubRegion" DataValueField="SubRegion" CssClass="Controls_DropDownList" AutoPostBack="true" OnSelectedIndexChanged="DropDownList_Doctor_SubRegion_SelectedIndexChanged">
                        <asp:ListItem Value="">Select Sub Region</asp:ListItem>
                      </asp:DropDownList>
                      <asp:ObjectDataSource ID="ObjectDataSource_Doctor_SubRegion" runat="server"></asp:ObjectDataSource>
                      &nbsp;&nbsp;&nbsp;
                      Town:&nbsp;
                      <asp:DropDownList ID="DropDownList_Doctor_Town" runat="server" DataSourceID="ObjectDataSource_Doctor_Town" AppendDataBoundItems="True" DataTextField="Town" DataValueField="Town" CssClass="Controls_DropDownList" AutoPostBack="true" OnSelectedIndexChanged="DropDownList_Doctor_Town_SelectedIndexChanged">
                        <asp:ListItem Value="">Select Town</asp:ListItem>
                      </asp:DropDownList>
                      <asp:ObjectDataSource ID="ObjectDataSource_Doctor_Town" runat="server"></asp:ObjectDataSource>
                    </td>
                  </tr>
                  <tr id="Doctor5">
                  ...
                  <tr id="Doctor6">
                    <td>Doctor:&nbsp;
                      <asp:DropDownList ID="DropDownList_Doctor_NamedropDown" runat="server" DataSourceID="ObjectDataSource_Doctor_NamedropDown" AppendDataBoundItems="True" DataTextField="Name" DataValueField="Name" CssClass="Controls_DropDownList">
            ...
            <table class="Table_Body">
              ...
              <tr>
                <td style="padding: 0px;">
                  <asp:DataList ID="DataList_ExecutiveMarketInquiry_Map_DoctorLegend_List" runat="server" RepeatLayout="Table" RepeatDirection="Horizontal">
                    <ItemTemplate>
                      <table>
                        <tr>
