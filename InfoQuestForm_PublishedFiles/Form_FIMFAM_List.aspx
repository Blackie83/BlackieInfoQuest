<%@ Page Language="C#" AutoEventWireup="true" Inherits="InfoQuestForm.Form_FIMFAM_List" CodeBehind="Form_FIMFAM_List.aspx.cs" %>
...
<head runat="server">
  <title>InfoQuest - FIM / FAM List</title>
...
<body>
  <form id="form_FIMFAM_List" runat="server" defaultbutton="Button_Search">
        ...
        <tr>
          <td>
            <table class="Record" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td>
                  <asp:GridView ID="GridView_FIMFAM_List" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource_FIMFAM_List" CssClass="Grid" AllowPaging="True" AllowSorting="True" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="20" OnPreRender="GridView_FIMFAM_List_PreRender" OnDataBound="GridView_FIMFAM_List_DataBound" OnRowCreated="GridView_FIMFAM_List_RowCreated">
                    ...
                    <PagerTemplate>
                      <table cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td>of
                          <%=GridView_FIMFAM_List.PageCount%>
                          </td>
                          <td>
                    ...
                    <Columns>
                      <asp:TemplateField HeaderText="">
                        <ItemTemplate>
                          <asp:HyperLink ID="Link" Text='<%# GetLink(Eval("Facility_Id") , Eval("FIMFAM_PI_PatientVisitNumber")) %>' runat="server"></asp:HyperLink>
                        </ItemTemplate>
                      </asp:TemplateField>
                      ...
                      <asp:BoundField DataField="FIMFAM_PI_PatientVisitNumber" HeaderText="Patient Visit Number" ReadOnly="True" SortExpression="FIMFAM_PI_PatientVisitNumber" />
                      <asp:BoundField DataField="FIMFAM_PI_PatientName" HeaderText="Patient Name" ReadOnly="True" SortExpression="FIMFAM_PI_PatientName" />
                      <asp:BoundField DataField="FIMFAM_PI_PatientAge" HeaderText="Age" ReadOnly="True" SortExpression="FIMFAM_PI_PatientAge" />
                      <asp:BoundField DataField="FIMFAM_PI_PatientDateOfAdmission" HeaderText="Admission Date" ReadOnly="True" SortExpression="FIMFAM_PI_PatientDateOfAdmission" />
                      <asp:BoundField DataField="FIMFAM_PI_PatientDateofDischarge" HeaderText="Discharge Date" ReadOnly="True" SortExpression="FIMFAM_PI_PatientDateofDischarge" />
                    </Columns>
                  </asp:GridView>
                  <asp:SqlDataSource ID="SqlDataSource_FIMFAM_List" runat="server" OnSelected="SqlDataSource_FIMFAM_List_Selected"></asp:SqlDataSource>
                </td>
              </tr>
            </table>
          </td>
