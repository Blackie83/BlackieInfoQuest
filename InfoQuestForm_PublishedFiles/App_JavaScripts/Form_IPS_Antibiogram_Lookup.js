...
function Validation_Form() {
  var FormMode;
  if (document.getElementById("FormView_IPS_Antibiogram_Lookup_Form_HiddenField_Insert")) {
    FormMode = "Insert";
  } else if (document.getElementById("FormView_IPS_Antibiogram_Lookup_Form_HiddenField_Edit")) {
    FormMode = "Edit";
  } else {
    FormMode = "";
  }
  ...
  if (FormMode != "") {
    if (document.getElementById("FormView_IPS_Antibiogram_Lookup_Form_TextBox_" + FormMode + "Code").value == "") {
    ...
    if (document.getElementById("FormView_IPS_Antibiogram_Lookup_Form_TextBox_" + FormMode + "Description").value == "") {
