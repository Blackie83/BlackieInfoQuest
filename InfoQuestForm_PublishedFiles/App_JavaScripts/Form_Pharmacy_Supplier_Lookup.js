...
{
  var FormMode;
  if (document.getElementById("FormView_Pharmacy_Supplier_Lookup_Form_HiddenField_Insert"))
  {
    FormMode = "Insert";
  } else if (document.getElementById("FormView_Pharmacy_Supplier_Lookup_Form_HiddenField_Edit"))
  {
    FormMode = "Edit";
  } else
  {
  ...
  if (FormMode != "")
  {
    if (document.getElementById("FormView_Pharmacy_Supplier_Lookup_Form_TextBox_" + FormMode + "Code").value == "")
    {
    ...
    if (document.getElementById("FormView_Pharmacy_Supplier_Lookup_Form_TextBox_" + FormMode + "Description").value == "")
    {
