<%@ Page Language="C#" AutoEventWireup="true" Inherits="InfoQuestForm.Form_MonthlyHospitalStatistics_Waste_Upload" CodeBehind="Form_MonthlyHospitalStatistics_Waste_Upload.aspx.cs" %>
...
<head runat="server">
  <title>InfoQuest - Monthly Hospital Statistics Waste Upload</title>
  <asp:PlaceHolder runat="server">
    <link href="App_Themes/LifeHealthcare/LifeHealthcare.css?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" rel="stylesheet" type="text/css" />
    <script src="App_Javascripts/InfoQuest_Loader.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
    <script src="App_Javascripts/InfoQuest_LoaderSettings.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
    <script src="App_Javascripts/Form_MonthlyHospitalStatistics_Waste_Upload.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
  </asp:PlaceHolder>
</head>
<body onload="Hide('Label_ProgressUpload');Hide('Label_ProgressDelete');Hide('Label_ProgressExtract');">
  <form id="form_MHS_Waste_Upload" runat="server">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <Navigation:NavigationMenu ID="NavigationMenu_Page" runat="server" />
    <div>
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_MHS_Waste_Upload" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_MHS_Waste_Upload" AssociatedUpdatePanelID="UpdatePanel_MHS_Waste_Upload">
        <ProgressTemplate>
      ...
      <asp:UpdatePanel ID="UpdatePanel_MHS_Waste_Upload" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td>
          ...
          <table id="TableTemplate" class="Table" style="width: 600px;" runat="server">
            <tr>
              <td>
                <table class="Table_Header">
                  <tr>
                    <td>
                      <asp:Label ID="Label_TemplateHeading" runat="server" Text=""></asp:Label>
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              <td>
                <table class="Table_Body">
                  <tr>
                    <td>Total Files:&nbsp;<asp:Label ID="Label_UploadedTemplateTotalFiles" runat="server" Text=""></asp:Label>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>
                      <asp:Label ID="Label_UploadedTemplateFiles" runat="server" Text=""></asp:Label>
                      <asp:Repeater ID="Repeater_UploadedTemplateFiles" runat="server">
                        <ItemTemplate>
                          <tr>
                            <td>
                              <%# Eval("Values") %> 
