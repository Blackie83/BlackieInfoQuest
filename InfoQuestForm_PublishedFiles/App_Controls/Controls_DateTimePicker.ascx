<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Controls_DateTimePicker.ascx.cs" Inherits="InfoQuestForm.Controls_DateTimePicker" %>
<table>
  <tr>
    <td>
    ...
    <td>&nbsp;</td>
    <td>
      <asp:DropDownList ID="DropDownList_Hour" runat="server" CssClass="Controls_DropDownList">
    ...
    <td> : </td>
    <td>
      <asp:DropDownList ID="DropDownList_Minute" runat="server" CssClass="Controls_DropDownList">
