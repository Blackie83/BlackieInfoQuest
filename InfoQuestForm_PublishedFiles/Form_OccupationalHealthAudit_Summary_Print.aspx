<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_OccupationalHealthAudit_Summary_Print.aspx.cs" Inherits="InfoQuestForm.Form_OccupationalHealthAudit_Summary_Print" %>
...
<head runat="server">
  <title>InfoQuest - Occupational Health Audit Summary Print</title>
...
<body>
  <form id="form_OccupationalHealthAudit_Summary_Print" runat="server">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <div>
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_OccupationalHealthAudit_Summary_Print" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_OccupationalHealthAudit_Summary_Print" AssociatedUpdatePanelID="UpdatePanel_OccupationalHealthAudit_Summary_Print">
        <ProgressTemplate>
        </ProgressTemplate>
      </asp:UpdateProgress>
      <asp:UpdatePanel ID="UpdatePanel_OccupationalHealthAudit_Summary_Print" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td>
            ...
            <tr>
              <td>
                <table class="Table_Body" style="border: 0px;">
                  ...
                  <tr>
                    <td style="font-weight: bold; border-color: Black; border-width: 1px; border-style: solid;">Unit:&nbsp;
                    </td>
                    <td style="border-color: Black; border-width: 1px; border-style: solid;" colspan="3">
                ...
                <table class="Table_Body">
                  <tr>
                    <td style="padding: 0px;">
                      <asp:GridView ID="GridView_OccupationalHealthAudit_Summary_List" runat="server" RowStyle-Font-Names="Verdana" ShowHeader="false" CellPadding="3" Width="100%" AutoGenerateColumns="False" DataSourceID="SqlDataSource_OccupationalHealthAudit_Summary_List" BorderWidth="0px" ShowHeaderWhenEmpty="True" PageSize="1000" OnPreRender="GridView_OccupationalHealthAudit_Summary_List_PreRender">
                        <EmptyDataTemplate>
                          <table>
                            <tr>
                              <td>No Summary
