<%@ Page Language="C#" AutoEventWireup="true" Inherits="InfoQuestForm.Form_CRM_IncompleteComplaints" CodeBehind="Form_CRM_IncompleteComplaints.aspx.cs" %>
...
<head runat="server">
  <title>InfoQuest - Customer Relationship Management Incomplete</title>
...
<body>
  <form id="form_CRM_IncompleteComplaints" runat="server">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <Navigation:NavigationMenu ID="NavigationMenu_Page" runat="server" />
    <div>
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_CRM_IncompleteComplaints" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_CRM_IncompleteComplaints" AssociatedUpdatePanelID="UpdatePanel_CRM_IncompleteComplaints">
        <ProgressTemplate>
      ...
      <asp:UpdatePanel ID="UpdatePanel_CRM_IncompleteComplaints" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td>
              ...
              <td>
                <table class="Table_Body">
                  ...
                  <tr>
                    ...
                    <td>Patient or Complainant Name
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <asp:DropDownList ID="DropDownList_EscalatedForm" runat="server" CssClass="Controls_DropDownList">
                ...
                <table class="Table_Body">
                  ...
                  <tr>
                    <td style="padding: 0px;">
                      <asp:GridView ID="GridView_CRM_IncompleteComplaints" runat="server" Width="1000px" AutoGenerateColumns="False" DataSourceID="SqlDataSource_CRM_IncompleteComplaints" CssClass="GridView" AllowPaging="True" AllowSorting="True" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="100" OnPreRender="GridView_CRM_IncompleteComplaints_PreRender" OnDataBound="GridView_CRM_IncompleteComplaints_DataBound" OnRowCreated="GridView_CRM_IncompleteComplaints_RowCreated">
                        ...
                        <PagerTemplate>
                          <table class="GridView_PagerStyle">
                            <tr>
                              ...
                              <td>of
                              <%=GridView_CRM_IncompleteComplaints.PageCount%>
                              </td>
                              <td>
                        ...
                        <Columns>
                          ...
                          <asp:BoundField DataField="CRM_PatientVisitNumber" HeaderText="Patient Visit Number" ReadOnly="True" SortExpression="CRM_PatientVisitNumber" />
                          ...
                          <asp:BoundField DataField="CRM_EscalatedForm" HeaderText="Escalated" ReadOnly="True" SortExpression="CRM_EscalatedForm" />
                          <asp:BoundField DataField="Tracking" HeaderText="Tracking" ReadOnly="True" SortExpression="Tracking" />
                          <asp:BoundField DataField="TrackingDays" HeaderText="Days" ReadOnly="True" SortExpression="TrackingDays" />
                        </Columns>
                      </asp:GridView>
                      <asp:SqlDataSource ID="SqlDataSource_CRM_IncompleteComplaints" runat="server" OnSelected="SqlDataSource_CRM_IncompleteComplaints_Selected"></asp:SqlDataSource>
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              <td>
                <table class="Table_Body">
                  ...
                  <tr>
                    <td style="padding: 0px;">
                      <asp:GridView ID="GridView_CRM_IncompleteComplaintsBulkApproval" runat="server" Width="1000px" AllowPaging="True" DataSourceID="SqlDataSource_CRM_IncompleteComplaintsBulkApproval" AutoGenerateColumns="false" CssClass="GridView" AllowSorting="True" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="100" OnPreRender="GridView_CRM_IncompleteComplaintsBulkApproval_PreRender" OnDataBound="GridView_CRM_IncompleteComplaintsBulkApproval_DataBound" OnRowCreated="GridView_CRM_IncompleteComplaintsBulkApproval_RowCreated">
                        <HeaderStyle CssClass="GridView_HeaderStyle" HorizontalAlign="Left" />
                        ...
                        <PagerTemplate>
                          <table class="GridView_PagerStyle">
                            <tr>
                              ...
                              <td>of
                              <%=GridView_CRM_IncompleteComplaintsBulkApproval.PageCount%>
                              </td>
                              <td>
                                <asp:ImageButton ID="ImageButton_Next" runat="server" CommandName="Page" CommandArgument="Next" ImageUrl="App_Themes/LifeHealthcare/Images/Blue/Next.gif" />
                                <asp:ImageButton ID="ImageButton_Last" runat="server" CommandName="Page" CommandArgument="Last" ImageUrl="App_Themes/LifeHealthcare/Images/Blue/Last.gif" />
                      ...
                      <asp:SqlDataSource ID="SqlDataSource_CRM_IncompleteComplaintsBulkApproval" runat="server" OnSelected="SqlDataSource_CRM_IncompleteComplaintsBulkApproval_Selected"></asp:SqlDataSource>
                    </td>
                  </tr>
                </table>
              </td>
