<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_SustainabilityManagement_EmptyFields.aspx.cs" Inherits="InfoQuestForm.Form_SustainabilityManagement_EmptyFields" %>
...
<head runat="server">
  <title>InfoQuest - Sustainability Management Empty Fields</title>
...
<body>
  <form id="form_SustainabilityManagement_EmptyFields" runat="server">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <Navigation:NavigationMenu ID="NavigationMenu_Page" runat="server" />
    <div>
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_SustainabilityManagement_EmptyFields" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_SustainabilityManagement_EmptyFields" AssociatedUpdatePanelID="UpdatePanel_SustainabilityManagement_EmptyFields">
        <ProgressTemplate>
      ...
      <asp:UpdatePanel ID="UpdatePanel_SustainabilityManagement_EmptyFields" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td>
              ...
              <td>
                <table class="Table_Body">
                  ...
                  <tr>
                    ...
                    <td>
                      <asp:DropDownList ID="DropDownList_PeriodFrom" runat="server" CssClass="Controls_DropDownList" AppendDataBoundItems="True" DataSourceID="SqlDataSource_PeriodFrom" DataTextField="SustainabilityManagement_Period" DataValueField="SustainabilityManagement_Period">
                    ...
                    <td>
                      <asp:DropDownList ID="DropDownList_PeriodTo" runat="server" CssClass="Controls_DropDownList" AppendDataBoundItems="True" DataSourceID="SqlDataSource_PeriodTo" DataTextField="SustainabilityManagement_Period" DataValueField="SustainabilityManagement_Period">
                        <asp:ListItem Value="">Select Month</asp:ListItem>
                      </asp:DropDownList>
                  ...
                  <tr>
                    ...
                    <td>
                      <asp:DropDownList ID="DropDownList_FYPeriodFrom" runat="server" CssClass="Controls_DropDownList" AppendDataBoundItems="True" DataSourceID="SqlDataSource_FYPeriodFrom" DataTextField="SustainabilityManagement_FYPeriod" DataValueField="SustainabilityManagement_FYPeriod">
                    ...
                    <td>
                      <asp:DropDownList ID="DropDownList_FYPeriodTo" runat="server" CssClass="Controls_DropDownList" AppendDataBoundItems="True" DataSourceID="SqlDataSource_FYPeriodTo" DataTextField="SustainabilityManagement_FYPeriod" DataValueField="SustainabilityManagement_FYPeriod">
                        <asp:ListItem Value="">Select Period</asp:ListItem>
                      </asp:DropDownList>
                  ...
                  <tr>
                    <td>Empty Field</td>
                    <td colspan="3">
                      <asp:DropDownList ID="DropDownList_EmptyField" runat="server" CssClass="Controls_DropDownList" AppendDataBoundItems="true" DataSourceID="SqlDataSource_EmptyField" DataTextField="ListItem_ListItemDisplayName" DataValueField="ListItem_Name">
                        <asp:ListItem Value="">Select Empty Field</asp:ListItem>
                      </asp:DropDownList>
                      <asp:SqlDataSource ID="SqlDataSource_EmptyField" runat="server"></asp:SqlDataSource>
                    </td>
                  </tr>
                </table>
              </td>
                ...
                <table class="Table_Body">
                  ...
                  <tr>
                    <td style="padding: 0px;">
                      <asp:GridView ID="GridView_SustainabilityManagement_EmptyFields" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource_SustainabilityManagement_EmptyFields" CssClass="GridView" AllowPaging="False" AllowSorting="True" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="20" OnPreRender="GridView_SustainabilityManagement_EmptyFields_PreRender" OnDataBound="GridView_SustainabilityManagement_EmptyFields_DataBound" OnRowCreated="GridView_SustainabilityManagement_EmptyFields_RowCreated">
                        ...
                        <PagerTemplate>
                          <table class="GridView_PagerStyle">
                            <tr>
                              ...
                              <td>of <%=GridView_SustainabilityManagement_EmptyFields.PageCount%>
                              </td>
                              <td>
                        ...
                        <Columns>
                          ...
                          <asp:BoundField DataField="Scope" HeaderText="Scope" ReadOnly="True" SortExpression="Scope" />
                          ...
                          <asp:BoundField DataField="Measurement" HeaderText="Measurement" ReadOnly="True" SortExpression="Measurement" />
                        </Columns>
                      </asp:GridView>
                      <asp:SqlDataSource ID="SqlDataSource_SustainabilityManagement_EmptyFields" runat="server" OnSelected="SqlDataSource_SustainabilityManagement_EmptyFields_Selected"></asp:SqlDataSource>
                    </td>
                  </tr>
                </table>
              </td>
