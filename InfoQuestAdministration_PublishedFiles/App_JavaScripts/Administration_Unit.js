...
function Validation_Form() {
  var FormMode;
  if (document.getElementById("FormView_Unit_Form_HiddenField_Insert")) {
    FormMode = "Insert";
  } else if (document.getElementById("FormView_Unit_Form_HiddenField_Edit")) {
    FormMode = "Edit";
  } else {
    FormMode = "";
  }
  ...
  if (FormMode != "") {
    if (document.getElementById("FormView_Unit_Form_TextBox_" + FormMode + "Name").value == "") {
    ...
    if (document.getElementById("FormView_Unit_Form_TextBox_" + FormMode + "Description").value == "") {
