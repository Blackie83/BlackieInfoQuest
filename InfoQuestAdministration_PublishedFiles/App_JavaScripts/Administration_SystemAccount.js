...
{
  var FormMode;
  if (document.getElementById("FormView_SystemAccount_Form_HiddenField_Insert"))
  {
    FormMode = "Insert";
  }
  else if (document.getElementById("FormView_SystemAccount_Form_HiddenField_Edit"))
  {
    FormMode = "Edit";
  }
  else
  ...
  if (FormMode != "")
  {
    if (document.getElementById("FormView_SystemAccount_Form_TextBox_" + FormMode + "Description").value == "")
    {
    ...
    if (document.getElementById("FormView_SystemAccount_Form_TextBox_" + FormMode + "Domain").value == "")
    {
    ...
    if (document.getElementById("FormView_SystemAccount_Form_TextBox_" + FormMode + "UserName").value == "")
    {
    ...
    if (document.getElementById("FormView_SystemAccount_Form_TextBox_" + FormMode + "Password").value == "")
    {
