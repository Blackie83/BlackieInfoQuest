...
{
  public partial class Administration_SecurityAccess : InfoQuestWCF.Override_SystemWebUIPage
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      if (PageSecurity() == "1")
      {
        ...
        ScriptManager.RegisterStartupScript(UpdatePanel_SecurityAccess, this.GetType(), "UpdateProgress", "Validation_Form();", true);
        ...
        if (!IsPostBack)
        {
          ...
          else
          {
            ...
            if (TableSecurityAccess1.Visible == true && TableSecurityAccess2.Visible == true)
            {
              SecurityAccess();
            }
          }
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
      ...
      if (PageSecurity() == "1")
      {
        Label Label_UpdateProgress = (Label)PageUpdateProgress_SecurityAccess.FindControl("Label_UpdateProgress");
    ...
    protected void Button_Search_Click(object sender, EventArgs e)
    {
      ...
      string FinalURL = "Administration_SecurityAccess.aspx?" + SearchField1 + SearchField2 + SearchField3;
      FinalURL = FinalURL.Remove(FinalURL.Length - 1, 1);
      FinalURL = InfoQuestWCF.InfoQuest_All.All_RedirectLink("Security Access", FinalURL);
    ...
    {
      string FinalURL = InfoQuestWCF.InfoQuest_All.All_RedirectLink("Security Access", "Administration_SecurityAccess.aspx");
      Response.Redirect(FinalURL, false);
    }
    //---END--- --Search--//
    ...
    {
      string LinkURL = "<a href='" + InfoQuestWCF.InfoQuest_All.All_RedirectLink("Security Access", "Administration_SecurityAccess.aspx?SecurityUser_Id=" + securityUser_Id + "") + "'>Update</a>";
    ...
    {
      string LinkURL = "<a href='" + InfoQuestWCF.InfoQuest_All.All_RedirectLink("Security Access", "Administration_SecurityAccess.aspx?SecurityUser_Id=" + securityUser_Id + "&Facility_Id=" + facility_Id + "") + "'>Update</a>";
    ...
    protected void CheckBoxList_SecurityRole_DataBound(object sender, EventArgs e)
    {
      if (Request.QueryString["SecurityUser_Id"] != null && !string.IsNullOrEmpty(DropDownList_Facility.SelectedValue))
      {
        ...
        for (int i = 0; i < CheckBoxList_SecurityRole.Items.Count; i++)
        {
          ...
          string SQLStringSecurityRoleId = "SELECT DISTINCT SecurityRole_Id FROM Administration_SecurityAccess WHERE SecurityUser_Id = @SecurityUser_Id AND Facility_Id = @Facility_Id AND SecurityRole_Id = @SecurityRole_Id";
    ...
    protected void Button_SecurityAccessAdd_Click(object sender, EventArgs e)
    {
      ...
      {
        ToolkitScriptManager_SecurityAccess.SetFocus(UpdatePanel_SecurityAccess);
    ...
    protected void Button_SecurityAccessDelete_Click(object sender, EventArgs e)
    {
      ...
      {
        string SQLStringDeleteSecurityAccess = "DELETE FROM Administration_SecurityAccess WHERE SecurityUser_Id = @SecurityUser_Id AND Facility_Id = @Facility_Id";
    ...
    private void SecurityAccessClear()
    {
      ...
      string FinalURL = "Administration_SecurityAccess.aspx?" + SearchField1 + SearchField2 + SearchField3 + SearchField4;
      FinalURL = FinalURL.Remove(FinalURL.Length - 1, 1);
      FinalURL = InfoQuestWCF.InfoQuest_All.All_RedirectLink("Security Access", FinalURL);
