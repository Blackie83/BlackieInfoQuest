...
<%@ Register Namespace="InfoQuestWCF" TagPrefix="AjaxHTMLEditor" Assembly="InfoQuestWCF" %>
                  ...
                  <InsertItemTemplate>
                    <table class="FormView_TableBody">
                      ...
                      <tr>
                        ...
                        <td>
                          <AjaxHTMLEditor:Override_AjaxControlToolkitHtmlEditorEditor ID="Editor_InsertDescription" runat="server" CssClass="Controls_AjaxHTMLEditor" Width="800px" Height="500px" ActiveMode="Html" Content='<%# Bind("Navigation_Description") %>' />
                          &nbsp;
                        </td>
                      </tr>
                      <tr>
