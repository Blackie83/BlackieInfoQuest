<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_FSM_Location_List.aspx.cs" Inherits="InfoQuestForm.Form_FSM_Location_List" %>
...
<head runat="server">
  <title>InfoQuest - Facility Structure Maintenance - Location List</title>
...
<body>
  <form id="form_FSM_Location_List" runat="server">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <Navigation:NavigationMenu ID="NavigationMenu_Page" runat="server" />
    <div>
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_FSM_Location_List" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_FSM_Location_List" AssociatedUpdatePanelID="UpdatePanel_FSM_Location_List">
        <ProgressTemplate>
      ...
      <asp:UpdatePanel ID="UpdatePanel_FSM_Location_List" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td>
                ...
                <table class="Table_Body">
                  ...
                  <tr>
                    <td style="padding: 0px;">
                      <asp:GridView ID="GridView_FSM_Location_List" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource_FSM_Location_List" CssClass="GridView" AllowPaging="True" AllowSorting="True" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="20" OnPreRender="GridView_FSM_Location_List_PreRender" OnDataBound="GridView_FSM_Location_List_DataBound" OnRowCreated="GridView_FSM_Location_List_RowCreated">
                        ...
                        <PagerTemplate>
                          <table class="GridView_PagerStyle">
                            <tr>
                              ...
                              <td>of
                          <%=GridView_FSM_Location_List.PageCount%>
                              </td>
                              <td>
                            ...
                            <tr>
                              <td colspan="10">
                                <asp:Button ID="Button_CaptureNew" runat="server" Text="Capture New Location" CssClass="Controls_Button" OnClick="Button_CaptureNew_Click" />&nbsp;
                              </td>
                            </tr>
                          </table>
                        </PagerTemplate>
                        ...
                        <Columns>
                          <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                              <asp:HyperLink ID="Link" Text='<%# GetLink(Eval("LocationKey")) %>' runat="server"></asp:HyperLink>
                            </ItemTemplate>
                          </asp:TemplateField>
                          <asp:BoundField DataField="LocationName" HeaderText="Name" ReadOnly="True" SortExpression="LocationName" />
                          <asp:BoundField DataField="CountryName" HeaderText="Country" ReadOnly="True" SortExpression="CountryName" />
                          <asp:BoundField DataField="ProvinceName" HeaderText="Province" ReadOnly="True" SortExpression="ProvinceName" />
                          <asp:BoundField DataField="IsActive" HeaderText="Is Active" ReadOnly="True" SortExpression="IsActive" />
                        </Columns>
                      </asp:GridView>
                      <asp:SqlDataSource ID="SqlDataSource_FSM_Location_List" runat="server" OnSelected="SqlDataSource_FSM_Location_List_Selected"></asp:SqlDataSource>
                    </td>
                  </tr>
                </table>
              </td>
