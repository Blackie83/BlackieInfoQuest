...
{
  var FormMode;
  if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_HiddenField_Edit"))
  {
    FormMode = "Edit";
  }
  else
  ...
  if (FormMode != "")
  {
    if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_DropDownList_" + FormMode + "TrackingList").value == "6143")
    {
      if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_TextBox_" + FormMode + "RootCause").value == "") {
      ...
      if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_TextBox_" + FormMode + "Actions").value == "")
      {
      ...
      if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_TextBox_" + FormMode + "ResponsiblePerson").value == "")
      {
      ...
      if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_TextBox_" + FormMode + "DueDate").value == "")
      {
      ...
      if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_DropDownList_" + FormMode + "ActionsEffective").value == "")
      {
      ...
      if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_DropDownList_" + FormMode + "LateClosingOutCNCList"))
      {
        if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_DropDownList_" + FormMode + "LateClosingOutCNCList").value == "")
        {
          document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_FormLateClosingOutCNCList").style.backgroundColor = "#d46e6e";
          document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_FormLateClosingOutCNCList").style.color = "#333333";
        }
        else
        {
          document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_FormLateClosingOutCNCList").style.backgroundColor = "#77cf9c";
          document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_FormLateClosingOutCNCList").style.color = "#333333";
        }

        if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_DropDownList_" + FormMode + "LateClosingOutCNCList").value == "6149")
        {
          if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_TextBox_" + FormMode + "LateClosingOutCNCListOther").value == "")
          {
    ...
    else
    {
      ...
      if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_DropDownList_" + FormMode + "LateClosingOutCNCList"))
      {
        document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_FormLateClosingOutCNCList").style.backgroundColor = "#f7f7f7";
        document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_FormLateClosingOutCNCList").style.color = "#000000";
      }

      if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_TextBox_" + FormMode + "LateClosingOutCNCListOther"))
      {
...
function ShowHide_Form()
{
  ...
  {
    FormMode = "Edit";
  } else if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_HiddenField_Item"))
  {
    FormMode = "Item"
  } else
  {
  ...
  if (FormMode != "")
  {
    if (FormMode != "Item")
    {
      if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_DropDownList_" + FormMode + "LateClosingOutCNCList"))
      {
        ...
        } else
        {
          ...
          document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_TextBox_" + FormMode + "LateClosingOutCNCListOther").value = "";
        }
      } else
      {
        Hide("LateClosingOutCNCListOther");
    ...
    if (FormMode == "Item")
    {
      if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_HiddenField_" + FormMode + "LateClosingOutCNCList").value == "")
      {
      ...
      } else
      {
        ...
        if (document.getElementById("FormView_OccupationalHealthAudit_Findings_Form_HiddenField_" + FormMode + "LateClosingOutCNCList").value == "6149")
        {
          Show("LateClosingOutCNCListOther");
        } else
        {
