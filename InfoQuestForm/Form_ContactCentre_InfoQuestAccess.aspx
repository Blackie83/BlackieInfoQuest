<%@ Page Language="C#" AutoEventWireup="true" Inherits="InfoQuestForm.Form_ContactCentre_InfoQuestAccess" CodeBehind="Form_ContactCentre_InfoQuestAccess.aspx.cs" %>
...
<head runat="server">
  <title>InfoQuest - Contact Centre InfoQuest Access</title>
  <asp:PlaceHolder runat="server">
    <link href="App_Themes/LifeHealthcare/LifeHealthcare.css?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" rel="stylesheet" type="text/css" />
    <script src="App_Javascripts/InfoQuest_Loader.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
    <script src="App_Javascripts/InfoQuest_LoaderSettings.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
    <script src="App_Javascripts/Form_ContactCentre_InfoQuestAccess.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
  </asp:PlaceHolder>
</head>
<body>
  <form id="form_ContactCentre_InfoQuestAccess" runat="server" defaultbutton="Button_Search">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <div style="max-width: 1000px;">
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_ContactCentre_InfoQuestAccess" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_ContactCentre_InfoQuestAccess" AssociatedUpdatePanelID="UpdatePanel_ContactCentre_InfoQuestAccess">
        <ProgressTemplate>
      ...
      <asp:UpdatePanel ID="UpdatePanel_ContactCentre_InfoQuestAccess" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td>
          ...
          <table style="width: 1000px" border="0">
            <tr>
              ...
              <td style="width: 670px; vertical-align:top;">
                <table id="TableSecurityUsers" runat="server" style="width:100%;" class="Table">
                  <tr>
                    <td>
                      <table class="Table_Header">
                        <tr>
                      ...
                      <table class="Table_Body">
                        ...
                        <tr>
                          <td style="padding: 0px;">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource_SecurityUser_List" runat="server" OnSelected="SqlDataSource_SecurityUser_List_Selected"></asp:SqlDataSource>
                          </td>
                        </tr>
                      </table>
                    </td>
            ...
            <tr>
              <td style="width: 310px; vertical-align:top;">
                <table id="TableSecurityAccess1" runat="server" style="width:100%;" class="Table">
                  <tr>
                    <td>
                      <table class="Table_Header">
                        <tr>
                          ...
                          <td style="padding: 0px;">
                            <asp:GridView ID="GridView_SecurityAccess_List" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource_SecurityAccess_List" CssClass="GridView" AllowPaging="True" AllowSorting="True" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="1000" OnPreRender="GridView_SecurityAccess_List_PreRender" OnRowCreated="GridView_SecurityAccess_List_RowCreated">
                              ...
                              <PagerTemplate>
                                <table class="GridView_PagerStyle">
                                  <tr>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button_ClearUser" runat="server" Text="Clear User" CssClass="Controls_Button" OnClick="Button_ClearUser_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                  </tr>
                                </table>
                              </PagerTemplate>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource_SecurityAccess_List" runat="server" OnSelected="SqlDataSource_SecurityAccess_List_Selected"></asp:SqlDataSource>
                          </td>
                        </tr>
                      </table>
                    </td>
              ...
              <td style="width: 670px; vertical-align:top;">
                <table id="TableSecurityAccess2" runat="server" style="width:100%;" class="Table">
                  <tr>
                    <td>
                      <table class="Table_Header">
                        <tr>
                  ...
                  <tr>
                    <td>
                      <table class="Table_Body">
                        ...
                        <tr>
                          <td style="width: 75px;" class="DetailsViewControlsValidation" id="FormFacility" runat="server">Facility
                          </td>
                          <td style="width: 580px;">
                        ...
                        <tr>
                          <td style="width: 75px;" class="DetailsViewControlsValidation" id="FormSecurityRole" runat="server">Security Role
                          </td>
                          <td style="width: 580px; padding: 0px; border-left-width: 0px; border-top-width: 1px;">
                            <div style="max-height: 450px; height: auto; overflow: auto; border-width: 0px; border-color: #dfdfdf; border-style: solid; vertical-align: top;">
                              <asp:CheckBoxList ID="CheckBoxList_SecurityRole" runat="server" AppendDataBoundItems="true" Width="575px" CssClass="Controls_CheckBoxListWithScrollbars" DataSourceID="SqlDataSource_SecurityRole" DataTextField="SecurityRole_Name" DataValueField="SecurityRole_Id" CellPadding="0" CellSpacing="0" RepeatLayout="Table" OnDataBound="CheckBoxList_SecurityRole_DataBound">
                              </asp:CheckBoxList>
                              <asp:SqlDataSource ID="SqlDataSource_SecurityRole" runat="server"></asp:SqlDataSource>
                            </div>
                          </td>
                        </tr>
                        <tr class="Bottom">
            ...
            <tr>
              <td colspan="3">
                <table id="TableSecurityAccess3" runat="server" style="width:100%;" class="Table">
                  <tr>
                    <td>
                      <table class="Table_Header">
                        <tr>
                          <td>List of Current User Security Access
                          </td>
                        </tr>
                      </table>
                    </td>
                  ...
                  <tr>
                    <td>
                      <table class="Table_Body">
                        <tr>
                          <td>Total Records:
                          <asp:Label ID="Label_TotalRecords_CurrentAccess" runat="server" Text=""></asp:Label>
                          </td>
                        </tr>
                        <tr>
                          <td style="padding: 0px;">
                            <asp:GridView ID="GridView_CurrentAccess" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource_CurrentAccess" CssClass="GridView" AllowPaging="True" AllowSorting="True" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="1000" OnPreRender="GridView_CurrentAccess_PreRender" OnRowCreated="GridView_CurrentAccess_RowCreated">
                              <HeaderStyle CssClass="GridView_HeaderStyle" HorizontalAlign="Left" />
                              <AlternatingRowStyle CssClass="GridView_AlternatingRowStyle" />
                              <PagerTemplate>
                                <table class="GridView_PagerStyle">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource_CurrentAccess" runat="server" OnSelected="SqlDataSource_CurrentAccess_Selected"></asp:SqlDataSource>
                          </td>
                        </tr>
                      </table>
                    </td>
