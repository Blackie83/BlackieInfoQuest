<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_ExecutiveMarketInquiry_Map_Hospital.aspx.cs" Inherits="InfoQuestForm.Form_ExecutiveMarketInquiry_Map_Hospital" MaintainScrollPositionOnPostback="true" %>
...
<head runat="server">
  <title>InfoQuest - Executive Market Inquiry - Map - Hospital</title>
  ...
  <asp:PlaceHolder runat="server">
    ...
    <script src="App_Javascripts/Form_ExecutiveMarketInquiry_Map_Hospital.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>"></script>
...
<body>
  <form id="form_ExecutiveMarketInquiry_Map_Hospital" runat="server">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <Navigation:NavigationMenu ID="NavigationMenu_Page" runat="server" />
    <div>
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_ExecutiveMarketInquiry_Map_Hospital" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_ExecutiveMarketInquiry_Map_Hospital" AssociatedUpdatePanelID="UpdatePanel_ExecutiveMarketInquiry_Map_Hospital">
        <ProgressTemplate>
      ...
      <asp:UpdatePanel ID="UpdatePanel_ExecutiveMarketInquiry_Map_Hospital" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td>
            ...
            <tr>
              <td>
                <table class="Table_Body">
                  ...
                  <tr id="Hospital1">
                    <td class="Table_BodyHeaderBlue">Hospital
                    </td>
                  </tr>
                  <tr id="Hospital2">
                    <td>Sub Region:&nbsp;
                      <asp:DropDownList ID="DropDownList_Hospital_SubRegion" runat="server" DataSourceID="ObjectDataSource_Hospital_SubRegion" AppendDataBoundItems="True" DataTextField="SubRegion" DataValueField="SubRegion" CssClass="Controls_DropDownList" AutoPostBack="true" OnSelectedIndexChanged="DropDownList_Hospital_SubRegion_SelectedIndexChanged">
                        <asp:ListItem Value="">Select Sub Region</asp:ListItem>
                      </asp:DropDownList>
                      <asp:ObjectDataSource ID="ObjectDataSource_Hospital_SubRegion" runat="server"></asp:ObjectDataSource>
                      &nbsp;&nbsp;&nbsp;
                      Town:&nbsp;
                      <asp:DropDownList ID="DropDownList_Hospital_Town" runat="server" DataSourceID="ObjectDataSource_Hospital_Town" AppendDataBoundItems="True" DataTextField="Town" DataValueField="Town" CssClass="Controls_DropDownList" AutoPostBack="true" OnSelectedIndexChanged="DropDownList_Hospital_Town_SelectedIndexChanged">
                        <asp:ListItem Value="">Select Town</asp:ListItem>
                      </asp:DropDownList>
                      <asp:ObjectDataSource ID="ObjectDataSource_Hospital_Town" runat="server"></asp:ObjectDataSource>
                    </td>
                  </tr>
                  <tr id="Hospital3">
                  ...
                  <tr id="Hospital4">
                    <td>Hospital:&nbsp;
                      <asp:DropDownList ID="DropDownList_Hospital_NamedropDown" runat="server" DataSourceID="ObjectDataSource_Hospital_NamedropDown" AppendDataBoundItems="True" DataTextField="Name" DataValueField="Name" CssClass="Controls_DropDownList">
                  ...
                  <tr id="Population2">
                    <td>Municipality:&nbsp;
                      <asp:DropDownList ID="DropDownList_Population_Municipality" runat="server" DataSourceID="ObjectDataSource_Population_Municipality" AppendDataBoundItems="true" DataTextField="Municipality" DataValueField="Municipality" CssClass="Controls_DropDownList">
            ...
            <table class="Table_Body">
              ...
              <tr>
                <td style="padding: 0px;">
                  <asp:DataList ID="DataList_ExecutiveMarketInquiry_Map_HospitalLegend_List" runat="server" RepeatLayout="Table" RepeatDirection="Horizontal">
                    <ItemTemplate>
                      <table>
                        <tr>
