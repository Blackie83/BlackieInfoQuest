<%@ Page Language="C#" AutoEventWireup="true" Inherits="InfoQuestForm.InfoQuest_ReportNumber" CodeBehind="InfoQuest_ReportNumber.aspx.cs" %>
...
<head runat="server">
  <title>InfoQuest - Report Number</title>
...
<body>
  <form id="form_ReportNumber" runat="server">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <div>
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_ReportNumber" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_ReportNumber" AssociatedUpdatePanelID="UpdatePanel_ReportNumber">
        <ProgressTemplate>
      ...
      <asp:UpdatePanel ID="UpdatePanel_ReportNumber" runat="server">
        <ContentTemplate>
