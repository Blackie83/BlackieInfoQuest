...
{
  public partial class Form_ExecutiveMarketInquiry_Map : InfoQuestWCF.Override_SystemWebUIPage
  {
    protected void Page_Load(object sender, EventArgs e)
    {
      if (PageSecurity() == "1")
      {
        ...
        ScriptManager.RegisterStartupScript(UpdatePanel_ExecutiveMarketInquiry_Map, this.GetType(), "UpdateProgress_Start", "Validation_Search();ShowHide_Search();", true);
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
      ...
      if (PageSecurity() == "1")
      {
        ((Label)PageUpdateProgress_ExecutiveMarketInquiry_Map.FindControl("Label_UpdateProgress")).Text = InfoQuestWCF.InfoQuest_All.All_UpdateProgress();
    ...
    private void DataSourceSetup()
    {
      ...
      DataSourceSetup_HospitalDoctor();
    ...
    private static void DataSourceSetup_HospitalDoctor()
    {
      //PageLoad PageLoad_Current = GetPageLoad();
      //MapTypeValue MapTypeValue_Current = GetMapTypeValue();

      //SqlDataSource_HospitalDoctor_SubRegion.ConnectionString = InfoQuestWCF.InfoQuest_Connections.Connections("PatientDetailODS");
      //SqlDataSource_HospitalDoctor_SubRegion.SelectCommand = "InfoQuest.ExecutiveMarketInquiry_List_HospitalDoctorSubRegionSP";
      //SqlDataSource_HospitalDoctor_SubRegion.SelectCommandType = SqlDataSourceCommandType.StoredProcedure;
      //SqlDataSource_HospitalDoctor_SubRegion.SelectParameters.Clear();
      //SqlDataSource_HospitalDoctor_SubRegion.SelectParameters.Add("Country", TypeCode.String, (Request.QueryString["s_Country"] ?? DropDownList_Country.SelectedValue ?? "").ToString());
      //SqlDataSource_HospitalDoctor_SubRegion.SelectParameters["Country"].ConvertEmptyStringToNull = false;
      //SqlDataSource_HospitalDoctor_SubRegion.SelectParameters.Add("Province", TypeCode.String, (PageLoad_Current.PageLoading == "Yes") ? (((String.IsNullOrEmpty(Request.QueryString["s_MapType"]) ? -1 : ((Request.QueryString["s_MapType"]).IndexOf("Hospital", StringComparison.CurrentCulture) >= 0) ? (Request.QueryString["s_MapType"]).IndexOf("Hospital", StringComparison.CurrentCulture) : ((Request.QueryString["s_MapType"]).IndexOf("Doctor", StringComparison.CurrentCulture) >= 0) ? (Request.QueryString["s_MapType"]).IndexOf("Doctor", StringComparison.CurrentCulture) : -1) >= 0) ? (Request.QueryString["s_Province"] ?? DropDownList_Province.SelectedValue ?? "") : "") : (((MapTypeValue_Current.HospitalAvailable) >= 0 || (MapTypeValue_Current.DoctorAvailable) >= 0) ? (Request.QueryString["s_Province"] ?? DropDownList_Province.SelectedValue ?? "").ToString() : ""));
      ////SqlDataSource_HospitalDoctor_SubRegion.SelectParameters["Province"].ConvertEmptyStringToNull = false;

      //SqlDataSource_HospitalDoctor_Town.ConnectionString = InfoQuestWCF.InfoQuest_Connections.Connections("PatientDetailODS");
      //SqlDataSource_HospitalDoctor_Town.SelectCommand = "InfoQuest.ExecutiveMarketInquiry_List_HospitalDoctorTownSP";
      //SqlDataSource_HospitalDoctor_Town.SelectCommandType = SqlDataSourceCommandType.StoredProcedure;
      //SqlDataSource_HospitalDoctor_Town.SelectParameters.Clear();
      //SqlDataSource_HospitalDoctor_Town.SelectParameters.Add("Country", TypeCode.String, (Request.QueryString["s_Country"] ?? DropDownList_Country.SelectedValue ?? "").ToString());
      //SqlDataSource_HospitalDoctor_Town.SelectParameters["Country"].ConvertEmptyStringToNull = false;
      //SqlDataSource_HospitalDoctor_Town.SelectParameters.Add("Province", TypeCode.String, (PageLoad_Current.PageLoading == "Yes") ? (((String.IsNullOrEmpty(Request.QueryString["s_MapType"]) ? -1 : ((Request.QueryString["s_MapType"]).IndexOf("Hospital", StringComparison.CurrentCulture) >= 0) ? (Request.QueryString["s_MapType"]).IndexOf("Hospital", StringComparison.CurrentCulture) : ((Request.QueryString["s_MapType"]).IndexOf("Doctor", StringComparison.CurrentCulture) >= 0) ? (Request.QueryString["s_MapType"]).IndexOf("Doctor", StringComparison.CurrentCulture) : -1) >= 0) ? (Request.QueryString["s_Province"] ?? DropDownList_Province.SelectedValue ?? "") : "") : (((MapTypeValue_Current.HospitalAvailable) >= 0 || (MapTypeValue_Current.DoctorAvailable) >= 0) ? (Request.QueryString["s_Province"] ?? DropDownList_Province.SelectedValue ?? "").ToString() : ""));
      ////SqlDataSource_HospitalDoctor_Town.SelectParameters["Province"].ConvertEmptyStringToNull = false;
      //SqlDataSource_HospitalDoctor_Town.SelectParameters.Add("SubRegion", TypeCode.String, (Request.QueryString["s_HDSubRegion"] ?? DropDownList_HospitalDoctor_SubRegion.SelectedValue ?? "").ToString());
      //SqlDataSource_HospitalDoctor_Town.SelectParameters["SubRegion"].ConvertEmptyStringToNull = false;
    }
    ...
    private void DataSourceSetup_Hospital()
    {
      ...
      ObjectDataSource_Hospital_Organisation.SelectParameters.Add("subRegion", TypeCode.String, (Request.QueryString["s_HDSubRegion"] ?? DropDownList_HospitalDoctor_SubRegion.SelectedValue ?? "").ToString());
      ObjectDataSource_Hospital_Organisation.SelectParameters["subRegion"].ConvertEmptyStringToNull = false;
      ObjectDataSource_Hospital_Organisation.SelectParameters.Add("town", TypeCode.String, (Request.QueryString["s_HDTown"] ?? DropDownList_HospitalDoctor_Town.SelectedValue ?? "").ToString());
      ...
      ObjectDataSource_Hospital_Type.SelectParameters.Add("subRegion", TypeCode.String, (Request.QueryString["s_HDSubRegion"] ?? DropDownList_HospitalDoctor_SubRegion.SelectedValue ?? "").ToString());
      ObjectDataSource_Hospital_Type.SelectParameters["subRegion"].ConvertEmptyStringToNull = false;
      ObjectDataSource_Hospital_Type.SelectParameters.Add("town", TypeCode.String, (Request.QueryString["s_HDTown"] ?? DropDownList_HospitalDoctor_Town.SelectedValue ?? "").ToString());
      ...
      //ObjectDataSource_Hospital_NamedropDown.SelectParameters.Add("subRegion", TypeCode.String, (Request.QueryString["s_HDSubRegion"] ?? DropDownList_HospitalDoctor_SubRegion.SelectedValue ?? "").ToString());
      //ObjectDataSource_Hospital_NamedropDown.SelectParameters["subRegion"].ConvertEmptyStringToNull = false;
      //ObjectDataSource_Hospital_NamedropDown.SelectParameters.Add("town", TypeCode.String, (Request.QueryString["s_HDTown"] ?? DropDownList_HospitalDoctor_Town.SelectedValue ?? "").ToString());
      ...
      ObjectDataSource_ExecutiveMarketInquiry_Hospital_List.SelectParameters.Add("province", TypeCode.String, (Request.QueryString["s_Province"] ?? "0").ToString());
      ObjectDataSource_ExecutiveMarketInquiry_Hospital_List.SelectParameters.Add("subRegion", TypeCode.String, Request.QueryString["s_HDSubRegion"]);
      ObjectDataSource_ExecutiveMarketInquiry_Hospital_List.SelectParameters.Add("town", TypeCode.String, Request.QueryString["s_HDTown"]);
    }
    ...
    private void DataSourceSetup_Doctor()
    {
      ...
      ObjectDataSource_Doctor_Organisation.SelectParameters.Add("subRegion", TypeCode.String, (Request.QueryString["s_HDSubRegion"] ?? DropDownList_HospitalDoctor_SubRegion.SelectedValue ?? "").ToString());
      ObjectDataSource_Doctor_Organisation.SelectParameters["subRegion"].ConvertEmptyStringToNull = false;
      ObjectDataSource_Doctor_Organisation.SelectParameters.Add("town", TypeCode.String, (Request.QueryString["s_HDTown"] ?? DropDownList_HospitalDoctor_Town.SelectedValue ?? "").ToString());
      ...
      ObjectDataSource_Doctor_Type.SelectParameters.Add("subRegion", TypeCode.String, (Request.QueryString["s_HDSubRegion"] ?? DropDownList_HospitalDoctor_SubRegion.SelectedValue ?? "").ToString());
      ObjectDataSource_Doctor_Type.SelectParameters["subRegion"].ConvertEmptyStringToNull = false;
      ObjectDataSource_Doctor_Type.SelectParameters.Add("town", TypeCode.String, (Request.QueryString["s_HDTown"] ?? DropDownList_HospitalDoctor_Town.SelectedValue ?? "").ToString());
      ...
      //ObjectDataSource_Doctor_NamedropDown.SelectParameters.Add("subRegion", TypeCode.String, (Request.QueryString["s_HDSubRegion"] ?? DropDownList_HospitalDoctor_SubRegion.SelectedValue ?? "").ToString());
      //ObjectDataSource_Doctor_NamedropDown.SelectParameters["subRegion"].ConvertEmptyStringToNull = false;
      //ObjectDataSource_Doctor_NamedropDown.SelectParameters.Add("town", TypeCode.String, (Request.QueryString["s_HDTown"] ?? DropDownList_HospitalDoctor_Town.SelectedValue ?? "").ToString());
      ...
      ObjectDataSource_ExecutiveMarketInquiry_Doctor_List.SelectParameters.Add("subRegion", TypeCode.String, Request.QueryString["s_HDSubRegion"]);
      ObjectDataSource_ExecutiveMarketInquiry_Doctor_List.SelectParameters.Add("town", TypeCode.String, Request.QueryString["s_HDTown"]);
    }
    ...
    private void SetFormQueryString()
    {
      ...
      SetFormQueryString_HospitalDoctor();
    ...
    private void SetFormQueryString_HospitalDoctor()
    {
      if (string.IsNullOrEmpty(DropDownList_HospitalDoctor_SubRegion.SelectedValue.ToString()))
      {
        if (Request.QueryString["s_HDSubRegion"] == null)
        {
          DropDownList_HospitalDoctor_SubRegion.SelectedValue = "";
        }
        else
        {
          DropDownList_HospitalDoctor_SubRegion.SelectedValue = Request.QueryString["s_HDSubRegion"];
        }
      }

      if (string.IsNullOrEmpty(DropDownList_HospitalDoctor_Town.SelectedValue.ToString()))
      {
        if (Request.QueryString["s_HDTown"] == null)
        {
          DropDownList_HospitalDoctor_Town.SelectedValue = "";
        }
        else
        {
          DropDownList_HospitalDoctor_Town.SelectedValue = Request.QueryString["s_HDTown"];
        }
      }
    }
    ...
    private void LoadMap()
    {
      ...
      //--START-- --MapLegend--//
      LoadMap_MapLegend(DataTable_ExecutiveMarketInquiry_Hospital, DataTable_ExecutiveMarketInquiry_Doctor, DataTable_ExecutiveMarketInquiry_Population, DataTable_ExecutiveMarketInquiry_MedicalScheme);
      //---END--- --MapLegend--//
      ...
      Int32 MarkerCount = HospitalCount + DoctorCount + PopulationCount + MedicalSchemeCount;
      //---END--- --MarkerCount--//
    ...
    private void LoadMap_MapLegend(DataTable dataTableExecutiveMarketInquiryHospital, DataTable dataTableExecutiveMarketInquiryDoctor, DataTable dataTableExecutiveMarketInquiryPopulation, DataTable dataTableExecutiveMarketInquiryMedicalScheme)
    {
      DataTable DataTable_ExecutiveMarketInquiry_MapLegend;
      using (DataTable_ExecutiveMarketInquiry_MapLegend = new DataTable())
      {
        DataTable_ExecutiveMarketInquiry_MapLegend.Clear();
        DataTable_ExecutiveMarketInquiry_MapLegend.Columns.Add("IconDescription");
        DataTable_ExecutiveMarketInquiry_MapLegend.Columns.Add("Icon");
        DataTable_ExecutiveMarketInquiry_MapLegend.Columns.Add("IconCount");
        DataTable_ExecutiveMarketInquiry_MapLegend.Locale = CultureInfo.CurrentCulture;
        ...
        if (dataTableExecutiveMarketInquiryHospital.Rows.Count > 0)
        {
          ...
          {
            DataTable_ExecutiveMarketInquiry_MapLegend.Rows.Add(DataRow_Row["Hospital_IconDescription"].ToString(), DataRow_Row["Hospital_Icon"].ToString());
          }
        }
        ...
        if (dataTableExecutiveMarketInquiryDoctor.Rows.Count > 0)
        {
          ...
          {
            DataTable_ExecutiveMarketInquiry_MapLegend.Rows.Add(DataRow_Row["Doctor_IconDescription"].ToString(), DataRow_Row["Doctor_Icon"].ToString());
          }
        }
        ...
        if (dataTableExecutiveMarketInquiryPopulation.Rows.Count > 0)
        {
          ...
          {
            DataTable_ExecutiveMarketInquiry_MapLegend.Rows.Add(DataRow_Row["Population_IconDescription"].ToString(), DataRow_Row["Population_Icon"].ToString());
          }
        }
        ...
        if (dataTableExecutiveMarketInquiryMedicalScheme.Rows.Count > 0)
        {
          ...
          {
            DataTable_ExecutiveMarketInquiry_MapLegend.Rows.Add(DataRow_Row["MedicalScheme_IconDescription"].ToString(), DataRow_Row["MedicalScheme_Icon"].ToString());
          }
        }


        var Query_IconCount = from DataTableRow in DataTable_ExecutiveMarketInquiry_MapLegend.AsEnumerable()
        ...
        DataTable_ExecutiveMarketInquiry_MapLegend = DataTable_ExecutiveMarketInquiry_MapLegend.DefaultView.ToTable(true, "IconDescription", "Icon", "IconCount").Copy();

        foreach (var Icons in Query_IconCount)
        {
          DataRow[] DataRow_Rows = DataTable_ExecutiveMarketInquiry_MapLegend.Select("Icon = '" + Icons.Icon + "'");
        ...
        DataTable_ExecutiveMarketInquiry_MapLegend.DefaultView.Sort = "IconDescription ASC";
        DataList_ExecutiveMarketInquiry_MapLegend_List.DataSource = DataTable_ExecutiveMarketInquiry_MapLegend.DefaultView.ToTable();
        DataList_ExecutiveMarketInquiry_MapLegend_List.DataBind();
      }
    }
    ...
    protected void CheckBoxList_MapType_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      if (GetPostBackControlName() == "CheckBoxList_MapType")
      {
        ...
        ObjectDataSource_Province.SelectParameters["Country"].DefaultValue = (MapTypeValue_Current.HospitalAvailable >= 0) ? DropDownList_Country.SelectedValue : (MapTypeValue_Current.DoctorAvailable >= 0) ? DropDownList_Country.SelectedValue : (MapTypeValue_Current.PopulationAvailable >= 0) ? DropDownList_Country.SelectedValue : (MapTypeValue_Current.MedicalSchemeAvailable >= 0) ? DropDownList_Country.SelectedValue : "";
        ...
        //String DropDownListHospitalDoctorSubRegionValue = DropDownList_HospitalDoctor_SubRegion.SelectedValue;
        //DropDownList_HospitalDoctor_SubRegion.Items.Clear();
        //ObjectDataSource_HospitalDoctor_SubRegion.SelectParameters["Country"].DefaultValue = (MapTypeValue_Current.HospitalAvailable >= 0) ? DropDownList_Country.SelectedValue : (MapTypeValue_Current.DoctorAvailable >= 0) ? DropDownList_Country.SelectedValue : "";
        //ObjectDataSource_HospitalDoctor_SubRegion.SelectParameters["Province"].DefaultValue = (MapTypeValue_Current.HospitalAvailable >= 0) ? DropDownList_Province.SelectedValue : (MapTypeValue_Current.DoctorAvailable >= 0) ? DropDownList_Province.SelectedValue : "";
        //DropDownList_HospitalDoctor_SubRegion.Items.Insert(0, new ListItem(Convert.ToString("Select Sub Region", CultureInfo.CurrentCulture), ""));
        //DropDownList_HospitalDoctor_SubRegion.DataBind();
        //DropDownList_HospitalDoctor_SubRegion.SelectedValue = (DropDownList_HospitalDoctor_SubRegion.Items.FindByValue(DropDownListHospitalDoctorSubRegionValue) != null) ? DropDownListHospitalDoctorSubRegionValue : "";

        //String DropDownListHospitalDoctorTownValue = DropDownList_HospitalDoctor_Town.SelectedValue;
        //DropDownList_HospitalDoctor_Town.Items.Clear();
        //ObjectDataSource_HospitalDoctor_Town.SelectParameters["Country"].DefaultValue = (MapTypeValue_Current.HospitalAvailable >= 0) ? DropDownList_Country.SelectedValue : (MapTypeValue_Current.DoctorAvailable >= 0) ? DropDownList_Country.SelectedValue : "";
        //ObjectDataSource_HospitalDoctor_Town.SelectParameters["Province"].DefaultValue = (MapTypeValue_Current.HospitalAvailable >= 0) ? DropDownList_Province.SelectedValue : (MapTypeValue_Current.DoctorAvailable >= 0) ? DropDownList_Province.SelectedValue : "";
        //ObjectDataSource_HospitalDoctor_Town.SelectParameters["SubRegion"].DefaultValue = (MapTypeValue_Current.HospitalAvailable >= 0) ? DropDownList_HospitalDoctor_SubRegion.SelectedValue : (MapTypeValue_Current.DoctorAvailable >= 0) ? DropDownList_HospitalDoctor_SubRegion.SelectedValue : "";
        //DropDownList_HospitalDoctor_Town.Items.Insert(0, new ListItem(Convert.ToString("Select Town", CultureInfo.CurrentCulture), ""));
        //DropDownList_HospitalDoctor_Town.DataBind();
        //DropDownList_HospitalDoctor_Town.SelectedValue = (DropDownList_HospitalDoctor_Town.Items.FindByValue(DropDownListHospitalDoctorTownValue) != null) ? DropDownListHospitalDoctorTownValue : "";
        ...
        ObjectDataSource_Hospital_Organisation.SelectParameters["SubRegion"].DefaultValue = (MapTypeValue_Current.HospitalAvailable >= 0) ? DropDownList_HospitalDoctor_SubRegion.SelectedValue : "";
        ObjectDataSource_Hospital_Organisation.SelectParameters["Town"].DefaultValue = (MapTypeValue_Current.HospitalAvailable >= 0) ? DropDownList_HospitalDoctor_Town.SelectedValue : "";
        ...
        ObjectDataSource_Hospital_Type.SelectParameters["SubRegion"].DefaultValue = (MapTypeValue_Current.HospitalAvailable >= 0) ? DropDownList_HospitalDoctor_SubRegion.SelectedValue : "";
        ObjectDataSource_Hospital_Type.SelectParameters["Town"].DefaultValue = (MapTypeValue_Current.HospitalAvailable >= 0) ? DropDownList_HospitalDoctor_Town.SelectedValue : "";
        ...
        //ObjectDataSource_Hospital_NamedropDown.SelectParameters["SubRegion"].DefaultValue = (MapTypeValue_Current.HospitalAvailable >= 0) ? DropDownList_HospitalDoctor_SubRegion.SelectedValue : "";
        //ObjectDataSource_Hospital_NamedropDown.SelectParameters["Town"].DefaultValue = (MapTypeValue_Current.HospitalAvailable >= 0) ? DropDownList_HospitalDoctor_Town.SelectedValue : "";
        ...
        ObjectDataSource_Doctor_Organisation.SelectParameters["SubRegion"].DefaultValue = (MapTypeValue_Current.DoctorAvailable >= 0) ? DropDownList_HospitalDoctor_SubRegion.SelectedValue : "";
        ObjectDataSource_Doctor_Organisation.SelectParameters["Town"].DefaultValue = (MapTypeValue_Current.DoctorAvailable >= 0) ? DropDownList_HospitalDoctor_Town.SelectedValue : "";
        ...
        ObjectDataSource_Doctor_Type.SelectParameters["SubRegion"].DefaultValue = (MapTypeValue_Current.DoctorAvailable >= 0) ? DropDownList_HospitalDoctor_SubRegion.SelectedValue : "";
        ObjectDataSource_Doctor_Type.SelectParameters["Town"].DefaultValue = (MapTypeValue_Current.DoctorAvailable >= 0) ? DropDownList_HospitalDoctor_Town.SelectedValue : "";
        ...
        //ObjectDataSource_Doctor_NamedropDown.SelectParameters["SubRegion"].DefaultValue = (MapTypeValue_Current.DoctorAvailable >= 0) ? DropDownList_HospitalDoctor_SubRegion.SelectedValue : "";
        //ObjectDataSource_Doctor_NamedropDown.SelectParameters["Town"].DefaultValue = (MapTypeValue_Current.DoctorAvailable >= 0) ? DropDownList_HospitalDoctor_Town.SelectedValue : "";
    ...
    protected void DropDownList_Country_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      //DropDownList_HospitalDoctor_SubRegion.Items.Clear();
      //ObjectDataSource_HospitalDoctor_SubRegion.SelectParameters["Country"].DefaultValue = (MapTypeValue_Current.HospitalAvailable >= 0) ? DropDownList_Country.SelectedValue : (MapTypeValue_Current.DoctorAvailable >= 0) ? DropDownList_Country.SelectedValue : "";
      //ObjectDataSource_HospitalDoctor_SubRegion.SelectParameters["Province"].DefaultValue = "";
      //DropDownList_HospitalDoctor_SubRegion.Items.Insert(0, new ListItem(Convert.ToString("Select Sub Region", CultureInfo.CurrentCulture), ""));
      //DropDownList_HospitalDoctor_SubRegion.DataBind();

      //DropDownList_HospitalDoctor_Town.Items.Clear();
      //ObjectDataSource_HospitalDoctor_Town.SelectParameters["Country"].DefaultValue = (MapTypeValue_Current.HospitalAvailable >= 0) ? DropDownList_Country.SelectedValue : (MapTypeValue_Current.DoctorAvailable >= 0) ? DropDownList_Country.SelectedValue : "";
      //ObjectDataSource_HospitalDoctor_Town.SelectParameters["Province"].DefaultValue = "";
      //ObjectDataSource_HospitalDoctor_Town.SelectParameters["SubRegion"].DefaultValue = "";
      //DropDownList_HospitalDoctor_Town.Items.Insert(0, new ListItem(Convert.ToString("Select Town", CultureInfo.CurrentCulture), ""));
      //DropDownList_HospitalDoctor_Town.DataBind();
    ...
    protected void DropDownList_HospitalDoctor_SubRegion_SelectedIndexChanged(object sender, EventArgs e)
    {
      MapTypeValue MapTypeValue_Current = GetMapTypeValue();
    ...
    protected void DropDownList_HospitalDoctor_Town_SelectedIndexChanged(object sender, EventArgs e)
    {
      MapTypeValue MapTypeValue_Current = GetMapTypeValue();
    ...
    protected void Button_Search_OnClick(object sender, EventArgs e)
    {
      ...
      string SearchField4 = DropDownList_HospitalDoctor_SubRegion.SelectedValue;
      string SearchField5 = DropDownList_HospitalDoctor_Town.SelectedValue;
      ...
      string SearchField10 = Server.HtmlEncode(TextBox_Doctor_Organisation.Text);
      string SearchField11 = DropDownList_Doctor_Type.SelectedValue;
      string SearchField12 = DropDownList_Doctor_NamedropDown.SelectedValue;
      string SearchField13 = Server.HtmlEncode(TextBox_Doctor_NameTextBox.Text);
      string SearchField14 = DropDownList_Population_Municipality.SelectedValue;
      ...
      else
      {
        ...
        {
          SearchField4 = "s_HDSubRegion=" + DropDownList_HospitalDoctor_SubRegion.SelectedValue.ToString() + "&";
        }

        if (!string.IsNullOrEmpty(SearchField5))
        {
          SearchField5 = "s_HDTown=" + DropDownList_HospitalDoctor_Town.SelectedValue.ToString() + "&";
        }
        ...
        {
          SearchField10 = "s_DOrganisation=" + Server.HtmlEncode(TextBox_Doctor_Organisation.Text).ToString() + "&";
        }

        if (!string.IsNullOrEmpty(SearchField11))
        {
          SearchField11 = "s_DType=" + DropDownList_Doctor_Type.SelectedValue.ToString() + "&";
        }

        if (!string.IsNullOrEmpty(SearchField12))
        {
          SearchField12 = "s_DNameDropDown=" + DropDownList_Doctor_NamedropDown.SelectedValue.ToString() + "&";
        }

        if (!string.IsNullOrEmpty(SearchField13))
        {
          SearchField13 = "s_DNameTextBox=" + Server.HtmlEncode(TextBox_Doctor_NameTextBox.Text).ToString() + "&";
        }

        if (!string.IsNullOrEmpty(SearchField14))
        {
          SearchField14 = "s_PMunicipality=" + DropDownList_Population_Municipality.SelectedValue.ToString() + "&";
        }

        string FinalURL = "Form_ExecutiveMarketInquiry_Map.aspx?" + SearchField1 + SearchField2 + SearchField3 + SearchField4 + SearchField5 + SearchField6 + SearchField7 + SearchField8 + SearchField9 + SearchField10 + SearchField11 + SearchField12 + SearchField13 + SearchField14;
    ...
    {
      Response.Redirect(InfoQuestWCF.InfoQuest_All.All_RedirectLink("Executive Market Inquiry Map", "Form_ExecutiveMarketInquiry_Map.aspx"), false);
    }
    //---END--- --Search--//
