<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_AAA_Test.aspx.cs" Inherits="InfoQuestForm.Form_AAA_Test" MaintainScrollPositionOnPostback="true" %>
...
<head runat="server">
  ...
  <asp:PlaceHolder runat="server">
    ...
    <link href="App_Themes/Bootstrap/bootstrap.css?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" rel="stylesheet" />
    <link href="App_Themes/Bootstrap/bootstrap-theme.css?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" rel="stylesheet" />
    <link href="App_Themes/Form_AAA_Test.css?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" rel="stylesheet" />
    ...
    <script src="App_JavaScripts/jQuery/jquery-2.2.4.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>"></script>
    <script src="App_JavaScripts/Bootstrap/bootstrap.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>"></script>
    <script src="App_JavaScripts/Holder/holder.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>"></script>
...
<body id="Body_AAA_Test" runat="server" style="margin: 0;">
  <form id="form_AAA_Test" runat="server">
    ...
    <%--<div id="PageLoad_Loader"></div>--%>


    <div <%--id="PageLoad_Page" class="animate-bottom" style="display: none;"--%>>
      ...
      <div class="container theme-showcase" role="main">
        ...
        <div class="page-header">
          <span class="btn btn-sm btn-default" ><asp:Button ID="Button_TestServerPost" runat="server" OnClick="Button_TestServerPost_Click" Text="Test Server Post"/></span>          
        </div>
