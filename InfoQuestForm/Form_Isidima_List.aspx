<%@ Page Language="C#" AutoEventWireup="true" Inherits="InfoQuestForm.Form_Isidima_List" CodeBehind="Form_Isidima_List.aspx.cs" %>
...
<head runat="server">
  <title>InfoQuest - Isidima List</title>
...
<body>
  <form id="form_Isidima_List" runat="server" defaultbutton="Button_Search">
        ...
        <tr>
          <td>
            <table class="Record" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td>
                  <asp:GridView ID="GridView_Isidima_List" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource_Isidima_List" CssClass="Grid" AllowPaging="True" AllowSorting="True" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="20" OnPreRender="GridView_Isidima_List_PreRender" OnDataBound="GridView_Isidima_List_DataBound" OnRowCreated="GridView_Isidima_List_RowCreated">
                    ...
                    <PagerTemplate>
                      <table cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td>of
                          <%=GridView_Isidima_List.PageCount%>
                          </td>
                          <td>
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="Isidima_PI_PatientAge" HeaderText="Age" ReadOnly="True" SortExpression="Isidima_PI_PatientAge" />
                      <asp:BoundField DataField="Isidima_PI_PatientDateOfAdmission" HeaderText="Admission Date" ReadOnly="True" SortExpression="Isidima_PI_PatientDateOfAdmission" />
                      <asp:BoundField DataField="Isidima_PI_PatientDateofDischarge" HeaderText="Discharge Date" ReadOnly="True" SortExpression="Isidima_PI_PatientDateofDischarge" />
                    </Columns>
                  </asp:GridView>
                  <asp:SqlDataSource ID="SqlDataSource_Isidima_List" runat="server" OnSelected="SqlDataSource_Isidima_List_Selected"></asp:SqlDataSource>
                </td>
              </tr>
            </table>
          </td>
