<%@ Page Language="C#" AutoEventWireup="true" Inherits="InfoQuestForm.Form_MHQ14_Required" CodeBehind="Form_MHQ14_Required.aspx.cs" %>
...
<head runat="server">
  <title>InfoQuest - Mental Health Questionnaire 14 Required</title>
...
<body>
  <form id="form_MHQ14_Required" runat="server" defaultbutton="Button_Search">
        ...
        <tr>
          <td>
            <table class="Record" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td>
                  <asp:GridView ID="GridView_MHQ14_Required" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource_MHQ14_Required" CssClass="Grid" AllowPaging="True" AllowSorting="True" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="20" OnPreRender="GridView_MHQ14_Required_PreRender" OnDataBound="GridView_MHQ14_Required_DataBound" OnRowCreated="GridView_MHQ14_Required_RowCreated">
                    ...
                    <PagerTemplate>
                      <table cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td>of
                          <%=GridView_MHQ14_Required.PageCount%>
                          </td>
                          <td>
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="MHQ14_Questionnaire_ReportNumber" HeaderText="Report Number" ReadOnly="True" SortExpression="MHQ14_Questionnaire_ReportNumber" />
                      <asp:BoundField DataField="MHQ14_Questionnaire_ADMS_Score" HeaderText="Admission Score" ReadOnly="True" SortExpression="MHQ14_Questionnaire_ADMS_Score" />
                    </Columns>
                  </asp:GridView>
                  <asp:SqlDataSource ID="SqlDataSource_MHQ14_Required" runat="server" OnSelected="SqlDataSource_MHQ14_Required_Selected"></asp:SqlDataSource>
                </td>
              </tr>
            </table>
          </td>
