<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_InfrastructureAudit_Summary.aspx.cs" Inherits="InfoQuestForm.Form_InfrastructureAudit_Summary" %>
...
<head runat="server">
  <title>InfoQuest - Infrastructure Audit Summary</title>
  <asp:PlaceHolder runat="server">
    <link href="App_Themes/LifeHealthcare/LifeHealthcare.css?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" rel="stylesheet" type="text/css" />
    <script src="App_Javascripts/InfoQuest_Loader.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
    <script src="App_Javascripts/InfoQuest_LoaderSettings.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
    <script src="App_Javascripts/Form_InfrastructureAudit_Summary.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
  </asp:PlaceHolder>
</head>
<body>
  <form id="form_InfrastructureAudit_Summary" runat="server">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <Navigation:NavigationMenu ID="NavigationMenu_Page" runat="server" />
    <div>
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_InfrastructureAudit_Summary" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_InfrastructureAudit_Summary" AssociatedUpdatePanelID="UpdatePanel_InfrastructureAudit_Summary">
        <ProgressTemplate>
      ...
      <asp:UpdatePanel ID="UpdatePanel_InfrastructureAudit_Summary" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td>
                ...
                <table class="Table_Body">
                  <tr>
                    <td style="padding: 0px;">
                      <asp:GridView ID="GridView_InfrastructureAudit_Summary_List" runat="server" Width="100%" ShowHeader="false" AutoGenerateColumns="False" DataSourceID="SqlDataSource_InfrastructureAudit_Summary_List" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="1000" OnRowCreated="GridView_InfrastructureAudit_Summary_List_RowCreated" OnPreRender="GridView_InfrastructureAudit_Summary_List_PreRender">
