<%@ Page Language="C#" AutoEventWireup="true" Inherits="InfoQuestForm.Form_PROMS_List" CodeBehind="Form_PROMS_List.aspx.cs" %>
...
<head runat="server">
  <title>InfoQuest - PROMS List</title>
...
<body>
  <form id="form_PROMS_List" runat="server" defaultbutton="Button_Search">
        ...
        <tr>
          <td>
            <table class="Record" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td>
                  <asp:GridView ID="GridView_PROMS_List" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource_PROMS_List" CssClass="Grid" AllowPaging="True" AllowSorting="True" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="20" OnPreRender="GridView_PROMS_List_PreRender" OnDataBound="GridView_PROMS_List_DataBound" OnRowCreated="GridView_PROMS_List_RowCreated">
                    ...
                    <Columns>
                      <asp:TemplateField HeaderText="">
                        <ItemTemplate>
                          <asp:HyperLink ID="Link" Text='<%# GetLink(Eval("Facility_Id") , Eval("PROMS_PI_PatientVisitNumber")) %>' runat="server"></asp:HyperLink>
                        </ItemTemplate>
                      </asp:TemplateField>
                      ...
                      <asp:BoundField DataField="PROMS_PI_PatientVisitNumber" HeaderText="Patient Visit Number" ReadOnly="True" SortExpression="PROMS_PI_PatientVisitNumber" />
                      <asp:BoundField DataField="PROMS_PI_PatientName" HeaderText="Patient Name" ReadOnly="True" SortExpression="PROMS_PI_PatientName" />
                      <asp:BoundField DataField="PROMS_PI_PatientAge" HeaderText="Age" ReadOnly="True" SortExpression="PROMS_PI_PatientAge" />
                      <asp:BoundField DataField="PROMS_PI_PatientDateOfAdmission" HeaderText="Admission Date" ReadOnly="True" SortExpression="PROMS_PI_PatientDateOfAdmission" />
                      <asp:BoundField DataField="PROMS_PI_PatientDateofDischarge" HeaderText="Discharge Date" ReadOnly="True" SortExpression="PROMS_PI_PatientDateofDischarge" />
                    </Columns>
                  </asp:GridView>
                  <asp:SqlDataSource ID="SqlDataSource_PROMS_List" runat="server" OnSelected="SqlDataSource_PROMS_List_Selected"></asp:SqlDataSource>
                </td>
              </tr>
            </table>
          </td>
