<%@ Page Language="C#" AutoEventWireup="true" Inherits="InfoQuestForm.Form_BundleCompliance_List" CodeBehind="Form_BundleCompliance_List.aspx.cs" %>
...
<head runat="server">
  <title>InfoQuest - Bundle Compliance List</title>
...
<body>
  <form id="form_BundleCompliance_List" runat="server" defaultbutton="Button_Search">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <Navigation:NavigationMenu ID="NavigationMenu_Page" runat="server" />
    <div>
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_BundleCompliance_List" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_BundleCompliance_List" AssociatedUpdatePanelID="UpdatePanel_BundleCompliance_List">
        <ProgressTemplate>
      ...
      <asp:UpdatePanel ID="UpdatePanel_BundleCompliance_List" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td>
                ...
                <table class="Table_Body">
                  ...
                  <tr>
                    <td style="padding: 0px;">
                      <asp:GridView ID="GridView_BundleCompliance_List" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource_BundleCompliance_List" CssClass="GridView" AllowPaging="True" AllowSorting="True" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="20" OnPreRender="GridView_BundleCompliance_List_PreRender" OnDataBound="GridView_BundleCompliance_List_DataBound" OnRowCreated="GridView_BundleCompliance_List_RowCreated">
                        ...
                        <PagerTemplate>
                          <table class="GridView_PagerStyle">
                            <tr>
                              ...
                              <td>of
                          <%=GridView_BundleCompliance_List.PageCount%>
                              </td>
                              <td>
                        ...
                        <Columns>
                          <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                              <asp:HyperLink ID="Link" Text='<%# GetLink(Eval("Facility_Id") , Eval("BC_PI_PatientVisitNumber")) %>' runat="server"></asp:HyperLink>
                            </ItemTemplate>
                          </asp:TemplateField>
                          ...
                          <asp:BoundField DataField="BC_PI_PatientVisitNumber" HeaderText="Patient Visit Number" ReadOnly="True" SortExpression="BC_PI_PatientVisitNumber" />
                          <asp:BoundField DataField="BC_PI_PatientName" HeaderText="Patient Name" ReadOnly="True" SortExpression="BC_PI_PatientName" />
                          <asp:BoundField DataField="BC_PI_PatientAge" HeaderText="Age" ReadOnly="True" SortExpression="BC_PI_PatientAge" />
                          <asp:BoundField DataField="BC_PI_PatientDateOfAdmission" HeaderText="Admission Date" ReadOnly="True" SortExpression="BC_PI_PatientDateOfAdmission" />
                          <asp:BoundField DataField="BC_PI_PatientDateOfDischarge" HeaderText="Discharge Date" ReadOnly="True" SortExpression="BC_PI_PatientDateOfDischarge" />
                        </Columns>
                      </asp:GridView>
                      <asp:SqlDataSource ID="SqlDataSource_BundleCompliance_List" runat="server" OnSelected="SqlDataSource_BundleCompliance_List_Selected"></asp:SqlDataSource>
                    </td>
                  </tr>
                </table>
              </td>
