<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_CollegeLearningAudit_Summary.aspx.cs" Inherits="InfoQuestForm.Form_CollegeLearningAudit_Summary" %>
...
<head runat="server">
  <title>InfoQuest - College Learning Audit Summary</title>
  <asp:PlaceHolder runat="server">
    <link href="App_Themes/LifeHealthcare/LifeHealthcare.css?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" rel="stylesheet" type="text/css" />
    <script src="App_Javascripts/InfoQuest_Loader.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
    <script src="App_Javascripts/InfoQuest_LoaderSettings.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
    <script src="App_Javascripts/Form_CollegeLearningAudit_Summary.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
  </asp:PlaceHolder>
</head>
<body>
  <form id="form_CollegeLearningAudit_Summary" runat="server">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <Navigation:NavigationMenu ID="NavigationMenu_Page" runat="server" />
    <div>
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_CollegeLearningAudit_Summary" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_CollegeLearningAudit_Summary" AssociatedUpdatePanelID="UpdatePanel_CollegeLearningAudit_Summary">
        <ProgressTemplate>
      ...
      <asp:UpdatePanel ID="UpdatePanel_CollegeLearningAudit_Summary" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td>
                ...
                <table class="Table_Body">
                  <tr>
                    <td style="padding: 0px;">
                      <asp:GridView ID="GridView_CollegeLearningAudit_Summary_List" runat="server" Width="100%" ShowHeader="false" AutoGenerateColumns="False" DataSourceID="SqlDataSource_CollegeLearningAudit_Summary_List" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="1000" OnRowCreated="GridView_CollegeLearningAudit_Summary_List_RowCreated" OnPreRender="GridView_CollegeLearningAudit_Summary_List_PreRender">
