<%@ Page Language="C#" AutoEventWireup="true" Inherits="InfoQuestForm.Form_Alert_List" CodeBehind="Form_Alert_List.aspx.cs" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="Ajax" %>
<%@ Register Src="App_Controls/Controls_Navigation.ascx" TagName="NavigationMenu" TagPrefix="Navigation" %>
<%@ Register Src="App_Controls/Controls_Header.ascx" TagName="HeaderText" TagPrefix="Header" %>
<%@ Register Src="App_Controls/Controls_Footer.ascx" TagPrefix="Footer" TagName="FooterText" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <title>InfoQuest - Alert List</title>
...
<body>
  <form id="form_Alert_List" runat="server">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <Navigation:NavigationMenu ID="NavigationMenu_Page" runat="server" />
    <div>
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_Alert_List" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_Alert_List" AssociatedUpdatePanelID="UpdatePanel_Alert_List">
        <ProgressTemplate>
      ...
      <asp:UpdatePanel ID="UpdatePanel_Alert_List" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td>
              ...
              <td>
                <table class="Table_Body">
                  ...
                  <tr>
                    ...
                    <td style="width: 875px;">
                      <asp:DropDownList ID="DropDownList_UnitToUnit" runat="server" CssClass="Controls_DropDownList" AppendDataBoundItems="True" DataSourceID="SqlDataSource_Alert_UnitToUnit" DataTextField="Unit_Name" DataValueField="Unit_Id">
                        <asp:ListItem Value="">Select Unit</asp:ListItem>
                      </asp:DropDownList>
                      <asp:SqlDataSource ID="SqlDataSource_Alert_UnitToUnit" runat="server"></asp:SqlDataSource>
                    </td>
                  </tr>
                  <tr>
                ...
                <table class="Table_Body">
                  ...
                  <tr>
                    <td style="padding: 0px;">
                      <asp:GridView ID="GridView_Alert_List" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource_Alert_List" Width="1000px" CssClass="GridView" AllowPaging="True" AllowSorting="True" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="20" OnPreRender="GridView_Alert_List_PreRender" OnDataBound="GridView_Alert_List_DataBound" OnRowCreated="GridView_Alert_List_RowCreated">
                          ...
                          <%=GridView_Alert_List.PageCount%>
                            ...
                            <tr>
                              <td colspan="10" style="text-align:center;">
                                <asp:Button ID="Button_CaptureNew" runat="server" Text="Capture New Alert" CssClass="Controls_Button" OnClick="Button_CaptureNew_Click" />&nbsp;
                              </td>
                            </tr>
                          </table>
                        </PagerTemplate>
                        ...
                        <Columns>
                          <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                              <asp:HyperLink ID="Link" Text='<%# GetLink(Eval("Alert_Id"), Eval("Facility_Id"), Eval("ViewUpdate")) %>' runat="server"></asp:HyperLink>
                            </ItemTemplate>
                          </asp:TemplateField>
                          ...
                          <asp:BoundField DataField="Alert_ReportNumber" HeaderText="Report Number" ReadOnly="True" SortExpression="Alert_ReportNumber" />
                          <asp:BoundField DataField="Alert_UnitTo_Name" HeaderText="Unit Issued To" ReadOnly="True" SortExpression="Alert_UnitTo_Name" />
                          <asp:BoundField DataField="Alert_Status" HeaderText="Form Status" ReadOnly="True" SortExpression="Alert_Status" />
                          <asp:BoundField DataField="Alert_StatusDate" HeaderText="Date" ReadOnly="True" SortExpression="Alert_StatusDate" />
                        </Columns>
                      </asp:GridView>
                      <asp:SqlDataSource ID="SqlDataSource_Alert_List" runat="server" OnSelected="SqlDataSource_Alert_List_Selected"></asp:SqlDataSource>
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              <td>
                <table class="Table_Body">
                  ...
                  <tr>
                    <td style="padding: 0px;">
                      <asp:GridView ID="GridView_Alert_BulkApproval" runat="server" AllowPaging="True" Width="1000px" DataSourceID="SqlDataSource_Alert_BulkApproval" AutoGenerateColumns="false" CssClass="GridView" AllowSorting="True" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="100" OnPreRender="GridView_Alert_BulkApproval_PreRender" OnDataBound="GridView_Alert_BulkApproval_DataBound" OnRowCreated="GridView_Alert_BulkApproval_RowCreated">
                        <HeaderStyle CssClass="GridView_HeaderStyle" HorizontalAlign="Left" />
                        <AlternatingRowStyle CssClass="GridView_AlternatingRowStyle" />
                        <PagerTemplate>
                          <table class="GridView_PagerStyle">
                            <tr>
                              ...
                              <td>of
                          <%=GridView_Alert_BulkApproval.PageCount%>
                              </td>
                              <td>
                            ...
                            <tr>
                              <td colspan="10" style="text-align:center;">
                                <asp:Button ID="Button_ApproveAll" runat="server" Text="Approve All Alerts" CssClass="Controls_Button" OnClick="Button_ApproveAll_Click" />&nbsp;
                          <asp:Button ID="Button_Update" runat="server" Text="Update Alerts" CssClass="Controls_Button" OnClick="Button_Update_Click" />&nbsp;
                        ...
                        <Columns>
                          ...
                          <asp:BoundField DataField="Facility_FacilityDisplayName" HeaderText="Facility" ReadOnly="True" SortExpression="Facility_FacilityDisplayName" />
                          <asp:BoundField DataField="Alert_ReportNumber" HeaderText="Report Number" ReadOnly="True" SortExpression="Alert_ReportNumber" />
                          <asp:BoundField DataField="Alert_Date" HeaderText="Date of Issue" ReadOnly="True" SortExpression="Alert_Date" />
                          <asp:BoundField DataField="Alert_Originator" HeaderText="Originator" ReadOnly="True" SortExpression="Alert_Originator" />
                          <asp:BoundField DataField="Alert_UnitFrom_Name" HeaderText="Unit Reported By" ReadOnly="True" SortExpression="Alert_UnitFrom_Name" />
                          <asp:BoundField DataField="Alert_UnitTo_Name" HeaderText="Unit Issued To" ReadOnly="True" SortExpression="Alert_UnitTo_Name" />
                          <asp:BoundField DataField="Alert_Description" HeaderText="Description of Alert" ReadOnly="True" SortExpression="Alert_Description" />
								          <asp:BoundField DataField="Alert_NumberOfInstances" HeaderText="Instances" ReadOnly="True" SortExpression="Alert_NumberOfInstances" />
                          <asp:TemplateField HeaderText="Form Status">
                            <ItemTemplate>
                              <asp:HiddenField ID="HiddenField_UpdateId" runat="server" Value='<%# Bind("Alert_Id") %>' />
                              <asp:DropDownList ID="DropDownList_UpdateStatus" runat="server" SelectedValue='<%# Bind("Alert_Status") %>' CssClass="Controls_DropDownList" OnSelectedIndexChanged="DropDownList_UpdateStatus_SelectedIndexChanged" AutoPostBack="true">
                                <asp:ListItem Value="Approved">Approved</asp:ListItem>
                                <asp:ListItem Value="Pending Approval">Pending Approval</asp:ListItem>
                                <asp:ListItem Value="Rejected">Rejected</asp:ListItem>
                              </asp:DropDownList>
                              <br />
                              <br />
                              <asp:Label ID="Label_UpdateStatusRejectedMessage" runat="server" Text="Rejection Reason is Required" Visible="false"></asp:Label>
                              <br />
                              <asp:Label ID="Label_UpdateStatusRejectedLabel" runat="server" Text="Rejection Reason:" Visible="false"></asp:Label>
                              <br />
                              <asp:TextBox ID="TextBox_UpdateStatusRejectedReason" runat="server" Text='<%# Bind("Alert_StatusRejectedReason") %>' Rows="4" Visible="false" CssClass="Controls_TextBox" TextMode="MultiLine">
                              </asp:TextBox>
                            </ItemTemplate>
                          </asp:TemplateField>
                        </Columns>
                      </asp:GridView>
                      <asp:SqlDataSource ID="SqlDataSource_Alert_BulkApproval" runat="server" OnSelected="SqlDataSource_Alert_BulkApproval_Selected"></asp:SqlDataSource>
                    </td>
                  </tr>
                </table>
              </td>
