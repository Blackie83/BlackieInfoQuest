<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_CRM_DiscoveryComment_Upload.aspx.cs" Inherits="InfoQuestForm.Form_CRM_DiscoveryComment_Upload" %>
...
<head runat="server">
  <title>InfoQuest - Customer Relationship Management - Discovery Comment Upload</title>
  <asp:PlaceHolder runat="server">
    <link href="App_Themes/LifeHealthcare/LifeHealthcare.css?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" rel="stylesheet" type="text/css" />
    <script src="App_Javascripts/InfoQuest_Loader.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
    <script src="App_Javascripts/InfoQuest_LoaderSettings.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
    <script src="App_Javascripts/Form_CRM_DiscoveryComment_Upload.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
  </asp:PlaceHolder>
</head>
<body onload="Hide('Label_ProgressUpload');Hide('Label_ProgressDelete');Hide('Label_ProgressExtract');">
  <form id="form_CRM_DiscoveryComment_Upload" runat="server">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <Navigation:NavigationMenu ID="NavigationMenu_Page" runat="server" />
    <div>
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_CRM_DiscoveryComment_Upload" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_CRM_DiscoveryComment_Upload" AssociatedUpdatePanelID="UpdatePanel_CRM_DiscoveryComment_Upload">
        <ProgressTemplate>
      ...
      <asp:UpdatePanel ID="UpdatePanel_CRM_DiscoveryComment_Upload" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td>
                ...
                <table class="Table_Body">
                  <tr>
                    <td>When uploading a document<br />
                      Only these document formats can be uploaded: Excel (.xls)<br />
