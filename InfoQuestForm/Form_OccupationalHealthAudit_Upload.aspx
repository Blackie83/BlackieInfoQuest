<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_OccupationalHealthAudit_Upload.aspx.cs" Inherits="InfoQuestForm.Form_OccupationalHealthAudit_Upload" %>
...
<head runat="server">
  <title>InfoQuest - Occupational Health Audit Upload</title>
  <asp:PlaceHolder runat="server">
    <link href="App_Themes/LifeHealthcare/LifeHealthcare.css?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" rel="stylesheet" type="text/css" />
    <script src="App_Javascripts/InfoQuest_Loader.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
    <script src="App_Javascripts/InfoQuest_LoaderSettings.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
    <script src="App_Javascripts/Form_OccupationalHealthAudit_Upload.js?Version=<%=InfoQuestWCF.InfoQuest_All.All_FileVersion() %>" type="text/javascript"></script>
  </asp:PlaceHolder>
</head>
<body onload="Hide('Label_ProgressUpload');Hide('Label_ProgressDelete');Hide('Label_ProgressExtract');">
  <form id="form_OccupationalHealthAudit_Upload" runat="server">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <Navigation:NavigationMenu ID="NavigationMenu_Page" runat="server" />
    <div>
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_OccupationalHealthAudit_Upload" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_OccupationalHealthAudit_Upload" AssociatedUpdatePanelID="UpdatePanel_OccupationalHealthAudit_Upload">
        <ProgressTemplate>
      ...
      <asp:UpdatePanel ID="UpdatePanel_OccupationalHealthAudit_Upload" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td>
