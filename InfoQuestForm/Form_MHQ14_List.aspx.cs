...
{
  public partial class Form_MHQ14_List : InfoQuestWCF.Override_SystemWebUIPage
  {
    protected void Page_Load(object sender, EventArgs e)
    {
      if (PageSecurity() == "1")
      {
        ...
        if (!IsPostBack)
        {
          ...
          Label_Title.Text = Convert.ToString((InfoQuestWCF.InfoQuest_All.All_FormName("34").Replace(" Form", "")).ToString() + " : Captured Forms", CultureInfo.CurrentCulture);
    ...
    private void SqlDataSourceSetup()
    {
      ...
      SqlDataSource_MHQ14_List.ConnectionString = InfoQuestWCF.InfoQuest_Connections.Connections("InfoQuest");
      SqlDataSource_MHQ14_List.SelectCommand = "spForm_Get_MHQ14_List";
      SqlDataSource_MHQ14_List.SelectCommandType = SqlDataSourceCommandType.StoredProcedure;
      SqlDataSource_MHQ14_List.CancelSelectOnNullParameter = false;
      SqlDataSource_MHQ14_List.SelectParameters.Clear();
      SqlDataSource_MHQ14_List.SelectParameters.Add("SecurityUser", TypeCode.String, Request.ServerVariables["LOGON_USER"]);
      SqlDataSource_MHQ14_List.SelectParameters.Add("FacilityId", TypeCode.String, Request.QueryString["s_Facility_Id"]);
      SqlDataSource_MHQ14_List.SelectParameters.Add("PatientVisitNumber", TypeCode.String, Request.QueryString["s_MHQ14_PatientVisitNumber"]);
      SqlDataSource_MHQ14_List.SelectParameters.Add("PatientName", TypeCode.String, Request.QueryString["s_MHQ14_PatientName"]);
      SqlDataSource_MHQ14_List.SelectParameters.Add("ReportNumber", TypeCode.String, Request.QueryString["s_MHQ14_ReportNumber"]);
    }
    ...
    protected void Button_Search_Click(object sender, EventArgs e)
    {
      ...
      else
      {
        ...
        string FinalURL = "Form_MHQ14_List.aspx?" + SearchField1 + SearchField2 + SearchField3 + SearchField4;
    ...
    //--START-- --List--//
    protected void SqlDataSource_MHQ14_List_Selected(object sender, SqlDataSourceStatusEventArgs e)
    {
      if (e != null)
      {
    ...
    {
      DropDownList DropDownList_PageSize = (DropDownList)GridView_MHQ14_List.BottomPagerRow.Cells[0].FindControl("DropDownList_PageSize");
      GridView_MHQ14_List.PageSize = Convert.ToInt32(DropDownList_PageSize.SelectedValue, CultureInfo.CurrentCulture);
    }

    protected void DropDownList_Page_SelectedIndexChanged(Object sender, EventArgs e)
    {
      DropDownList DropDownList_PageList = (DropDownList)GridView_MHQ14_List.BottomPagerRow.Cells[0].FindControl("DropDownList_Page");
      GridView_MHQ14_List.PageIndex = DropDownList_PageList.SelectedIndex;
    }

    protected void GridView_MHQ14_List_PreRender(object sender, EventArgs e)
    {
      ...
      if (GridViewRow_List != null)
      {
        ...
        DropDownList DropDownList_PageSize = (DropDownList)GridView_MHQ14_List.BottomPagerRow.Cells[0].FindControl("DropDownList_PageSize");
        if (GridView_MHQ14_List.PageSize <= 20)
        {
          DropDownList_PageSize.SelectedValue = "20";
        }
        else if (GridView_MHQ14_List.PageSize > 20 && GridView_MHQ14_List.PageSize <= 50)
        {
          DropDownList_PageSize.SelectedValue = "50";
        }
        else if (GridView_MHQ14_List.PageSize > 50 && GridView_MHQ14_List.PageSize <= 100)
        {
    ...
    protected void GridView_MHQ14_List_DataBound(object sender, EventArgs e)
    {
      GridViewRow GridViewRow_List = GridView_MHQ14_List.BottomPagerRow;
      if (GridViewRow_List != null)
      {
        DropDownList DropDownList_PageList = (DropDownList)GridViewRow_List.Cells[0].FindControl("DropDownList_Page");
        if (GridViewRow_List != null)
        {
          for (int i = 0; i < GridView_MHQ14_List.PageCount; i++)
          {
            int pageNumber = i + 1;
            ListItem ListItem_Item = new ListItem(pageNumber.ToString(CultureInfo.CurrentCulture));
            if (i == GridView_MHQ14_List.PageIndex)
            {
    ...
    protected void GridView_MHQ14_List_RowCreated(object sender, GridViewRowEventArgs e)
    {
      if (e != null)
      {
    ...
    {
      string LinkURL = "";
      LinkURL = "<a href='Form_MHQ14.aspx?s_Facility_Id=" + facilityId + "&s_MHQ14_PatientVisitNumber=" + patientVisitNumber + "&MHQ14_Questionnaire_Id=" + mhq14_Questionnaire_Id + "'>View</a>";
      ...
      else
      {
        ...
        {
          SearchField2 = "Search_MHQ14PatientVisitNumber=" + Request.QueryString["s_MHQ14_PatientVisitNumber"] + "&";
        }
        ...
        {
          SearchField3 = "Search_MHQ14PatientName=" + Request.QueryString["s_MHQ14_PatientName"] + "&";
        }
        ...
        {
          SearchField4 = "Search_MHQ14ReportNumber=" + Request.QueryString["s_MHQ14_ReportNumber"] + "&";
        }
