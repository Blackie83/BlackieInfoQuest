<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_VTE_List.aspx.cs" Inherits="InfoQuestForm.Form_VTE_List" %>
...
<head runat="server">
  <title>InfoQuest - VTE List</title>
...
<body>
  <form id="form_VTE_List" runat="server">
    <Header:HeaderText ID="HeaderText_Page" runat="server" />
    <Navigation:NavigationMenu ID="NavigationMenu_Page" runat="server" />
    <div>
      <Ajax:ToolkitScriptManager ID="ToolkitScriptManager_VTE_List" runat="server" CombineScripts="false">
      </Ajax:ToolkitScriptManager>
      <asp:UpdateProgress runat="server" ID="PageUpdateProgress_VTE_List" AssociatedUpdatePanelID="UpdatePanel_VTE_List">
        <ProgressTemplate>
      ...
      <asp:UpdatePanel ID="UpdatePanel_VTE_List" runat="server">
        <ContentTemplate>
          <table>
            <tr>
              <td>
              ...
              <td>
                <table class="Table_Body">
                  <tr>
                    ...
                    <td>
                      <asp:DropDownList ID="DropDownList_Facility" runat="server" CssClass="Controls_DropDownList" AppendDataBoundItems="True" DataSourceID="SqlDataSource_VTE_Facility" DataTextField="Facility_FacilityDisplayName" DataValueField="Facility_Id" AutoPostBack="True" OnSelectedIndexChanged="DropDownList_Facility_SelectedIndexChanged">
                  ...
                  <tr>
                    ...
                    <td>
                      <asp:DropDownList ID="DropDownList_Unit" runat="server" CssClass="Controls_DropDownList" AppendDataBoundItems="True" DataSourceID="SqlDataSource_VTE_Unit" DataTextField="Unit_Name" DataValueField="Unit_Id">
                        <asp:ListItem Value="">Select Unit</asp:ListItem>
                      </asp:DropDownList>
                      <asp:SqlDataSource ID="SqlDataSource_VTE_Unit" runat="server"></asp:SqlDataSource>
                    </td>
                  </tr>
                  <tr>
                ...
                <table class="Table_Body">
                  ...
                  <tr>
                    <td style="padding: 0px;">
                      <asp:GridView ID="GridView_VTE_List" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource_VTE_List" CssClass="GridView" AllowPaging="True" AllowSorting="True" BorderWidth="0px" ShowFooter="True" ShowHeaderWhenEmpty="True" PageSize="20" OnPreRender="GridView_VTE_List_PreRender" OnDataBound="GridView_VTE_List_DataBound" OnRowCreated="GridView_VTE_List_RowCreated">
                        ...
                        <Columns>
                          <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                              <asp:HyperLink ID="Link" Text='<%# GetLink(Eval("VTE_VisitInformation_Id")) %>' runat="server"></asp:HyperLink>
                            </ItemTemplate>
                          </asp:TemplateField>
                          ...
                          <asp:BoundField DataField="VTE_VisitInformation_VisitNumber" HeaderText="Patient Visit Number" ReadOnly="True" SortExpression="VTE_VisitInformation_VisitNumber" />
                          ...
                          <asp:BoundField DataField="VTE_VisitInformation_PatientAge" HeaderText="Age" ReadOnly="True" SortExpression="VTE_VisitInformation_PatientAge" />
                          <asp:BoundField DataField="VTE_VisitInformation_DateOfAdmission" HeaderText="Admission Date" ReadOnly="True" SortExpression="VTE_VisitInformation_DateOfAdmission" />
                          <asp:BoundField DataField="VTE_VisitInformation_DateOfDischarge" HeaderText="Discharge Date" ReadOnly="True" SortExpression="VTE_VisitInformation_DateOfDischarge" />
                        </Columns>
                      </asp:GridView>
                      <asp:SqlDataSource ID="SqlDataSource_VTE_List" runat="server" OnSelected="SqlDataSource_VTE_List_Selected"></asp:SqlDataSource>
                    </td>
                  </tr>
                </table>
              </td>
